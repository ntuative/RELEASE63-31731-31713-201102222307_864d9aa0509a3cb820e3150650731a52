package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_855:Number = 64;
      
      public static const const_1010:Number = 32;
      ...
      private var var_1901:Number = 1.0;
      
      private var var_1900:Number = 1.0;
      ...
      private var var_2786:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1899 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_81.x * this.var_437,this.var_81.y * this.var_436,this.var_81.z * this.var_435);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_265.x,this.var_265.y,this.var_265.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_437 != param1 * this.var_1901)
         {
            this.var_437 = param1 * this.var_1901;
            ++this.var_162;
         }
      }
      ...
      {
         if(this.var_436 != param1 * this.var_1900)
         {
            this.var_436 = param1 * this.var_1900;
            ++this.var_162;
         }
      }
      ...
      {
         if(this.var_435 != param1 * this.var_1899)
         {
            this.var_435 = param1 * this.var_1899;
            ++this.var_162;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_81.y /= this.var_436;
         this.var_81.z /= this.var_435;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_265.x;
         var _loc3_:Number = this.var_265.y;
         var _loc4_:Number = this.var_265.z;
         this.var_265.assign(param1);
         if(this.var_265.x != _loc2_ || this.var_265.y != _loc3_ || this.var_265.z != _loc4_)
         {
            ++this.var_162;
         }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_521 != null)
         {
            ...
            this.var_521.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_521.add(_loc3_,_loc4_);
            ++this.var_162;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_521 != null)
         {
            ...
            return this.var_521.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1206.assign(_loc22_);
         }
         else
         {
            this.var_1206.assign(_loc17_);
         }
         ++this.var_162;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.z *= this.var_435;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1206);
         if(_loc3_ < this.var_2785 || _loc3_ > this.var_2786)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_436;
            _loc2_.z *= this.var_435;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1206);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_81.x * this.var_437,this.var_81.y * this.var_436,this.var_81.z * this.var_435);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_150;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_437,param2.y * this.var_436,param2.z * this.var_435);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_437,param3.y * this.var_436,param3.z * this.var_435);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_437,param4.y * this.var_436,param4.z * this.var_435);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1010;
         }
         else
         {
            this.scale = const_855;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_855;
      }
