package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_844:String = "AssetLibraryLoaded";
      
      public static const const_1485:String = "AssetLibraryUnloaded";
      
      public static const const_1466:String = "AssetLibraryLoadError";
      ...
      private static var var_921:Array = new Array();
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_921.splice(var_921.indexOf(this),1);
            --var_499;
            this.var_500 = null;
            this.var_923 = null;
            this.var_154 = null;
      ...
      {
         if(this._file == param1.url && this.var_922)
         {
            if(!this.var_920 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_743,this.var_602);
            }
            this.var_920 = param2;
      ...
      public function unload() : void
      {
         ...
         this.var_922 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1485));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_923[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1132,this.assetLoadEventHandler);
      ...
      {
         return this.var_154[param1] != null || (this.var_602 != null ? this.var_602[param1] != null : false);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(this.var_419[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_743 = _loc2_.manifest.copy();
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1466));
         this.var_41 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_743.child("library");
         if(_loc2_ == null)
         {
