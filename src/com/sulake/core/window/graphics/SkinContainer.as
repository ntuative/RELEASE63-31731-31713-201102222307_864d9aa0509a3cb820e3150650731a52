package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_920:uint = 8;
      
      private static const const_1273:String = "skin";
      
      private static const const_1274:String = "bitmap";
      
      private static const const_1271:String = "fill";
      
      private static const const_1270:String = "text";
      
      private static const const_1269:String = "label";
      
      private static const const_1272:String = "shape";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "CanCreateRoomMessageComposer";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1610,this.var_2208);
         this.var_2210 = new Dictionary();
         this.var_2209 = new Dictionary();
         StateCodeTable.fillTables(this.var_2210,this.var_2209);
         this.var_396 = new Dictionary();
         this.var_396[const_1273] = BitmapSkinRenderer;
         this.var_396[const_1274] = BitmapDataRenderer;
         this.var_396[const_1271] = FillSkinRenderer;
         this.var_396[const_1270] = TextSkinRenderer;
         this.var_396[const_1269] = LabelRenderer;
         this.var_396[const_1272] = ShapeSkinRenderer;
         this.var_396[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_396[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_317 == null)
         {
            var_317 = new Array();
            var_317.push(WindowState.const_71);
            var_317.push(WindowState.const_80);
            var_317.push(WindowState.const_90);
            var_317.push(WindowState.const_54);
            var_317.push(WindowState.const_89);
            var_317.push(WindowState.const_83);
            var_317.push(WindowState.const_104);
            var_317.push(WindowState.const_96);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2727 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1610[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_870[param1] = new Array(const_920);
         }
         this.var_870[param1][param2] = param3;
         if(this.var_871[param1] == null)
         {
            this.var_871[param1] = new Array(const_920);
         }
