package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_800:IWindowContextStateListener;
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_179;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_649.x || _loc3_.stageY != this.var_649.y)
            {
               this.var_649.x = _loc3_.stageX;
               this.var_649.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_137.groupParameterFilteredChildrenUnderPoint(this.var_649,_loc6_,WindowParam.const_30);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_83 != this.var_137 && !this.var_83.disposed)
                  {
                     ...
                     this.var_83 = WindowController(this.var_137);
                  }
               }
            }
            while(--_loc4_ > -1)
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_83 && !this.var_83.disposed)
                     {
                        ...
                        {
                           this.var_800.mouseEventReceived(_loc3_.type,this.var_83);
                        }
                     }
                  }
