package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_995:String = "_EXCLUDE";
      
      public static const const_1777:String = "_INCLUDE";
      
      public static const const_1745:String = "_TEMP";
      
      private static const const_1240:String = "layout";
      
      private static const const_908:String = "window";
      
      private static const const_910:String = "variables";
      
      private static const const_909:String = "filters";
      
      private static const const_588:String = "name";
      
      private static const const_1230:String = "style";
      
      private static const const_587:String = "params";
      
      private static const const_1243:String = "tags";
      ...
      private static const const_1235:String = "visible";
      ...
      private static const const_1030:String = "blend";
      
      private static const const_1239:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1231:String = "treshold";
      
      private static const const_1242:String = "children";
      
      private static const const_1227:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1229:String = "height_min";
      
      private static const const_1233:String = "height_max";
      ...
      private static const const_1228:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1234:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1226:Dictionary;
      
      protected var var_1227:Dictionary;
      
      protected var var_991:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1226,this.var_1227);
         this.var_991 = new Dictionary();
         this.var_1481 = new Dictionary();
         ParamCodeTable.fillTables(this.var_991,this.var_1481);
         this.var_1970 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1234,const_47);
         return param1.replace(const_1228,const_47);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1227)
            {
               delete this.var_1227[_loc1_];
            }
            for(_loc1_ in this.var_991)
            {
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1240)
         {
            _loc8_ = param1.child(const_910);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_909).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1226[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_588,variables,"")));
         style = uint(this.parseAttribute(xml,const_1230,variables,style));
         params = uint(this.parseAttribute(xml,const_587,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1243,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_163));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_163));
         rect.width = Number(this.parseAttribute(xml,const_1232,variables,const_163));
         rect.height = Number(this.parseAttribute(xml,const_1238,variables,const_163));
         visible = this.parseAttribute(xml,const_1235,variables,visible.toString()) == const_586;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_587).length() > 0)
         {
            list = xml.child(const_587).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_588,variables,"") as String;
               if(this.var_991[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_588)) + "\"!");
               }
               params |= this.var_991[param];
               i++;
            }
         }
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_910)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1227,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1229,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1233,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_586;
         blend = Number(this.parseAttribute(xml,const_1030,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1239,variables,window.clipping.toString()) == const_586;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1231,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_909).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc3_:String = this.var_1227[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_995) == -1)
                  {
