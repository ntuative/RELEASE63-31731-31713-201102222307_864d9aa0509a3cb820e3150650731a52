package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_173:String = "regular";
      ...
      private static var var_460:Array;
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_84[const_173],var_84[ITALIC],var_84[BOLD]];
            var_84.reset();
            var_84[const_173] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_460.indexOf(_loc4_.name) == -1)
            {
               var_460.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         if(countSubStrings(param1,const_591) != countSubStrings(param1,const_592))
         {
            throw new Error("Mismatching amount of \"" + const_591 + "\" versus \"" + const_592 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1248) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1249) + 2,_loc5_.length);
            }
