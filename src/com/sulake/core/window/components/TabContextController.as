package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1342:String = "_SELECTOR";
      
      private static const const_1341:String = "_CONTENT";
       
      
      protected var var_999:ITabSelectorWindow;
      
      protected var var_1987:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_999 = findChildByTag(const_1342) as ITabSelectorWindow;
            if(this.var_999 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1987 = findChildByTag(const_1341) as IWindowContainer;
         }
      ...
      {
         return !!this.var_733 ? this.selector.iterator : null;
      }
