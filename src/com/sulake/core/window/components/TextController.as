package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1212:Dictionary = createPropertySetterTable();
      ...
      private var var_429:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_429,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_429 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_429,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_173);
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_429);
      }
      ...
      {
         return new Rectangle(this.var_806 * this.maxScrollH,this.var_534 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_429);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1210) ? new PropertyStruct(PropertyDefaults.const_878,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_983) : PropertyDefaults.const_1544);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1091 ? new PropertyStruct(PropertyDefaults.const_670,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1079) : PropertyDefaults.const_1593);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_992 ? new PropertyStruct(PropertyDefaults.const_1105,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1195) : PropertyDefaults.const_1564);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_731) ? new PropertyStruct(PropertyDefaults.const_396,this._field.textColor,PropertyStruct.const_150,true) : PropertyDefaults.const_1194);
         _loc1_.push(this.var_429 != TextStyleManager.const_173 ? new PropertyStruct(PropertyDefaults.const_399,this.var_429,PropertyStruct.const_53,true,PropertyDefaults.const_659) : PropertyDefaults.const_1020);
         _loc1_.push(this.var_39.left != PropertyDefaults.const_789 ? new PropertyStruct(PropertyDefaults.const_226,this.var_39.left,PropertyStruct.const_39,true) : PropertyDefaults.const_431);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_641 ? new PropertyStruct(PropertyDefaults.const_240,this.var_39.top,PropertyStruct.const_39,true) : PropertyDefaults.const_435);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_725 ? new PropertyStruct(PropertyDefaults.const_254,this.var_39.right,PropertyStruct.const_39,true) : PropertyDefaults.const_480);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_709 ? new PropertyStruct(PropertyDefaults.const_215,this.var_39.bottom,PropertyStruct.const_39,true) : PropertyDefaults.const_511);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_979 ? new PropertyStruct(PropertyDefaults.const_783,this._field.mouseWheelEnabled,PropertyStruct.const_35,true) : PropertyDefaults.const_1621);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_216,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_216,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_216,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
