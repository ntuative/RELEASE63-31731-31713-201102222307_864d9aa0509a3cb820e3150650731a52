package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_1000:Boolean;
      ...
      protected var var_1238:Number;
      
      protected var var_1237:Boolean = false;
      
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         this._spacing = PropertyDefaults.const_444;
         this.var_808 = PropertyDefaults.const_801;
         this.var_380 = PropertyDefaults.const_640;
         this.var_1000 = PropertyDefaults.const_694;
         this.var_653 = 0;
         this.var_654 = 0;
         this.var_103 = 0;
         this.var_92 = 0;
         ...
         var_164 = var_441 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_391,WindowStyle.const_813,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_48,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_578,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_314,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_544,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_1000;
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_653)
         {
            ...
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_67);
            dispatchEvent(new WindowEvent(WindowEvent.const_445,this,null));
         }
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_457,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_578,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_314,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_171:
               if(this.var_1237)
               {
                  this.var_1236 = this.var_1989 - _loc3_;
                  this.var_1238 = this.var_1990 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1236 != 0 && this.var_103 != 0)
                     {
                        this.scrollH += this.var_1236 / this.var_103;
                     }
                  }
                  else if(this.var_1238 != 0 && this.var_92 != 0)
                  {
                     this.scrollV += this.var_1238 / this.var_92;
                  }
                  this.var_1989 = _loc3_;
                  this.var_1990 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_179:
               if(this.var_1237)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1236,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1238);
                  }
                  this.var_1237 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_808 && !this.var_536 && this._container)
         {
            this.var_536 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_444)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_343,this._spacing,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1138);
         }
         if(this.var_808 != PropertyDefaults.const_801)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_627,this.var_808,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1394);
         }
         if(this.var_380 != PropertyDefaults.const_640)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_815,this.var_380,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1411);
         }
         if(this.var_1000 != PropertyDefaults.const_694)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_746,this.var_1000,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1478);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_343:
               ...
               case PropertyDefaults.const_627:
                  this.var_808 = _loc2_.value as Boolean;
                  break;
            }
         }
