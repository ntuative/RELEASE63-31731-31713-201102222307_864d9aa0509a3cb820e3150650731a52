package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_411)
         {
            this.var_411.removeEventListener(WindowEvent.const_312,this.scrollBarEventProc);
            this.var_411.removeEventListener(WindowEvent.const_255,this.scrollBarEventProc);
            this.var_411 = null;
         }
         if(this.var_1130)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1130)
         {
            this.var_1130 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_411)
         {
            ...
            if(this.var_411)
            {
               this.var_411.addEventListener(WindowEvent.const_312,this.scrollBarEventProc);
               this.var_411.addEventListener(WindowEvent.const_255,this.scrollBarEventProc);
            }
         }
         return this.var_411;
      }
