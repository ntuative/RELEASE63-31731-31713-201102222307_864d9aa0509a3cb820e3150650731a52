package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_733:Boolean = false;
      ...
      {
         if(param1.type == WindowTouchEvent.const_521)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_733 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_361,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_680,false,PropertyStruct.const_35,true) : PropertyDefaults.const_1594);
         _loc1_.push(this.var_1235 != PropertyDefaults.const_986 ? new PropertyStruct(PropertyDefaults.const_714,this.var_1235,PropertyStruct.const_35,true) : PropertyDefaults.const_1463);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1028 ? new PropertyStruct(PropertyDefaults.const_735,_field.selectable,PropertyStruct.const_35,true) : PropertyDefaults.const_1430);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1161 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_35,true) : PropertyDefaults.const_1650);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_714:
                  this.var_1235 = _loc2_.value as Boolean;
                  if(this.var_1235)
                  {
               ...
               case PropertyDefaults.const_680:
                  ...
                  break;
               case PropertyDefaults.const_1129:
