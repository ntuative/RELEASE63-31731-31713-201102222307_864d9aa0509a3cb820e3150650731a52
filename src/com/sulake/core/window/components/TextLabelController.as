package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_429);
         if(_loc1_)
         {
      ...
      {
         if(this.var_429 != param1.name)
         {
            this.var_429 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2387 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_344 != _loc2_.color : this.var_344 != null && this.var_344 != PropertyDefaults.const_731) ? new PropertyStruct(PropertyDefaults.const_396,this.var_344,PropertyStruct.const_150,true) : PropertyDefaults.const_1194);
         if(this.var_39)
         {
            if(this.var_39.left != PropertyDefaults.const_789)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_226,this.var_39.left,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_431);
            }
            if(this.var_39.top != PropertyDefaults.const_641)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_240,this.var_39.top,PropertyStruct.const_39,true));
            }
            else
            {
            ...
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_254,this.var_39.right,PropertyStruct.const_39,true));
            }
            else
            {
            ...
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_215,this.var_39.bottom,PropertyStruct.const_39,true));
            }
            else
            {
