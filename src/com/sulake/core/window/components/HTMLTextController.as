package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_812:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_655:String;
      
      private var var_1005:String = null;
      
      private var var_1495:StyleSheet = null;
      ...
      {
         this.var_655 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1005 == param2)
         {
            return;
         }
         param1.var_1005 = param2;
         param1.var_1495 = null;
         if(param1.var_1005 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1005);
            param1.var_1495 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_826.indexOf(param1) > -1)
         {
            this.var_655 = param1;
         }
      }
      ...
      {
         return this.var_655 == LinkTarget.const_31 ? defaultLinkTarget : this.var_655;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1495;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_655 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_776,this.var_655,PropertyStruct.const_53,true,PropertyDefaults.const_826));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_776)
            {
               this.var_655 = _loc2_.value as String;
               break;
            }
