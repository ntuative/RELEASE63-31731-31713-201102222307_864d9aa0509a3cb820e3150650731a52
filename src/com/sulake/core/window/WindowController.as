package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private var var_368:Rectangle;
      
      private var var_2559:uint;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_735 = _loc13_.blend;
            var_440 = _loc13_.var_2727;
            if(var_441 != _loc13_.background)
            {
      ...
      {
         var_441 = param1;
         var_229 = !!var_441 ? uint(var_229 | var_530) : uint(var_229 & 16777215);
      ...
      {
         var_530 = param1 & 4278190080;
         var_229 = !!var_441 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_67);
      }
      ...
      {
         var_530 = param1 << 24;
         var_229 = !!var_441 ? uint(var_530 | var_229) : uint(16777215 & var_229);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_67);
      }
      
      public function set blend(param1:Number) : void
      {
         var_735 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_368 = this._parent.rectangle.clone();
               var_61.x = var_11.x;
               var_61.y = var_11.y;
               var_61.width = var_11.width;
               var_61.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_486,this,this._parent));
            }
            else
            {
               this.var_368.x = 0;
               this.var_368.y = 0;
               this.var_368.width = 0;
               this.var_368.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1025,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_82,var_18,_context,var_11,null,this.var_651,this.properties,var_797.concat(),_id) as WindowController;
         _loc2_.var_440 = var_440;
         _loc2_.var_164 = this.var_164;
         _loc2_._debug = this._debug;
         _loc2_.var_368 = this.var_368.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2559 + "]";
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         _context.invalidate(this,param1,WindowRedrawFlag.const_67);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_528)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_513)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1145,this,null,true);
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_862))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_43:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1133;
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_194:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_196,WindowParam.const_164))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_193,WindowParam.const_161))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_457))
                        {
               ...
               case WindowNotifyEvent.const_499:
                  _context.invalidate(this,var_11.union(var_61),WindowRedrawFlag.const_492);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1094,this,null));
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_406:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_741,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_257,this._parent,this));
                     }
                  }
                  break;
               ...
               case WindowNotifyEvent.const_516:
                  if(!(var_18 & 0))
                  {
                     if(!this.var_20)
                     {
                        ...
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_492);
                     }
                  }
                  else if(var_18 & 0)
                  {
               ...
               case WindowNotifyEvent.const_569:
                  this._parent.getRegionProperties(null,this.var_368);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1074:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1607:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1586:
               _loc2_ = "null";
               break;
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_127,WindowParam.const_164);
         var _loc2_:* = !testParamFlag(WindowParam.const_148,WindowParam.const_161);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_368.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_368.height;
               _loc5_ = uint(var_18 & 0);
      ...
      {
         if(_state == WindowState.const_537)
         {
            return true;
         }
         _state = WindowState.const_537;
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1035,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_406;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1185 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_375,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1185 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_770,this,param1));
         return param1;
      }
