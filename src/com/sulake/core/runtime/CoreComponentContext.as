package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1285:String = "asset-libraries";
      
      private static const const_1286:String = "library";
      
      private static const const_1282:String = "service-libraries";
      
      private static const const_1283:String = "library";
      
      private static const const_1284:String = "component-libraries";
      
      private static const const_1279:String = "library";
      
      private static const const_1281:String = "error_data";
      
      private static const const_1280:String = "error_cat";
      ...
      private var var_713:IEventDispatcher;
      
      private var var_484:uint;
      
      private var var_404:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1015:
               ...
               this.var_404 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_902:
               debug("Core; using complex frame update handler");
               this.var_404 = this.complexFrameUpdateHandler;
               break;
            case Core.const_1524:
               debug("Core; using profiler frame update handler");
               this.var_404 = this.profilerFrameUpdateHandler;
               this.var_245 = new Profiler(this);
               attachComponent(this.var_245,[new IIDProfiler()]);
               var_446.addChild(new ProfilerViewer(this.var_245));
               break;
            case Core.const_825:
               debug("Core; using experimental frame update handler");
               this.var_404 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_404 = this.debugFrameUpdateHandler;
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            while(_loc3_ < CoreComponentContext.const_123)
            {
               _loc2_ = this.var_403[_loc3_] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1281,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1280,String(param3));
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_713 = loadingEventDelegate;
         if(this.var_340 == null)
         {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_278,e);
         }
         try
         {
            node = config.child(const_1282)[0];
            if(node != null)
            {
               list = node.child(const_1283);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_278,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_278,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1561);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_713)
         {
            this.var_713.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_713)
         {
            ...
            this.var_713.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_713)
                  {
                     this.var_713.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_484 - this.var_340.length,this.var_484,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = this.var_403[param2] as Array;
         if((this.var_1335 & 0) == Core.const_825)
         {
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = this.var_403[_loc4_] as Array;
            if((this.var_1335 & 0) == Core.const_825)
            {
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_404(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(criticality < CoreComponentContext.const_123)
         {
            ...
            receivers = this.var_403[criticality];
            index = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_123)
         {
            ...
            {
               if(this.var_581[priority] < priority)
               {
                  ++this.var_581[priority];
                  skip = true;
               }
            }
            if(!skip)
            {
               this.var_581[priority] = 0;
               receivers = this.var_403[priority];
               index = 0;
               length = receivers.length;
               while(index != length)
               {
