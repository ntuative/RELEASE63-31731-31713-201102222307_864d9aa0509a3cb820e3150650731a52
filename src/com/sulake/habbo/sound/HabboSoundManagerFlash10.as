package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_480:Number = 1.0;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1154,this.onTraxLoadComplete);
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_167.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_167.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_878.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_878 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_167 == null || this._connection == null || this._roomEngine == null || this.var_572 != null)
         {
            return;
         }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         if(this.var_573.length == 0 && this.var_705 != -1)
         {
            this.var_877.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1154,this.var_705));
            this.var_705 = -1;
            this.var_877 = null;
         }
      }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1475,this.var_705));
         this.var_705 = -1;
         this.var_877 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_480 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_480 * 100)));
         }
      }
      ...
      {
         this.var_480 = param1;
         this.var_572.updateVolume(this.var_480);
      ...
      private function setHabboToolbarIconState(param1:Boolean) : void
      {
         ...
         this.var_182.events.dispatchEvent(_loc2_);
      }
   }
}
