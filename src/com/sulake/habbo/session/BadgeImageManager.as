package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1575:String = "normal_badge";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         switch(param2)
         {
            case const_1575:
               ...
               {
                  _loc5_ = this.var_167.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_1077:
               if(this.var_167 != null)
               {
                  if(this.var_167 != null)
                  {
                     _loc5_ = this.var_167.getKey("group.badge.url");
