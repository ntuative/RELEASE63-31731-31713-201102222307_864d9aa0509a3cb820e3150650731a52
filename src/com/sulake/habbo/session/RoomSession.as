package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1996:int = 2500;
      ...
      private var var_1212:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1212 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1212.connection = param1;
         }
      }
      ...
      public function start() : Boolean
      {
         ...
         {
            this._state = RoomSessionEvent.const_93;
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1473));
         this.var_1472.add(this.var_1473,getTimer());
         ++this.var_1473;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1472.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_1996)
            {
      ...
      {
         return this.var_1212 as IUserDataManager;
      }
