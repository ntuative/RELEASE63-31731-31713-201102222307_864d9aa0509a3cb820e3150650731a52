package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_234,Tabs.const_394);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_234,Tabs.const_867);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_234,Tabs.const_394,"" + _loc3_);
         }
      }
   }
}
