package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_948:int = 1;
      ...
      private var var_1162:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_457 = new Timer(300,1);
         this.var_457.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_457)
            {
               this.var_457.removeEventListener(TimerEvent.TIMER,this.onResizeTimer);
               this.var_457.reset();
               this.var_457 = null;
            }
            if(this.var_943)
      ...
      private function prepare() : void
      {
         ...
         this.var_174 = IWindowContainer(this.var_16.findChildByName("tab_content"));
         this.var_218 = IWindowContainer(this.var_16.findChildByName("custom_content"));
         this.var_201 = IWindowContainer(this.var_16.findChildByName("list_content"));
         this.var_255 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1408 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1162 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_1162)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1162.procedure = this.onHotelView;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1557,true);
      }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:int = this.var_201.y;
         Util.moveChildrenToColumn(this.var_174,["custom_content","list_content"],this.var_218.y,8);
         this.var_201.height = this.var_201.height + _loc1_ - this.var_201.y - this.var_255.height + this.var_2523;
         Util.moveChildrenToColumn(this.var_174,["list_content","custom_footer"],this.var_201.y,0);
         this.var_2523 = this.var_255.height;
      ...
      private function refreshList(param1:Boolean, param2:Boolean, param3:IViewCtrl, param4:String) : void
      {
         ...
         {
            _loc5_ = this.var_201.getChildByName(param4);
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_616 == const_948)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_201.blend - _loc2_));
            this.var_201.blend = _loc3_;
            this.var_218.blend = !!this.var_1164 ? Number(_loc3_) : Number(1);
            this.var_255.blend = !!this.var_1164 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_616 = const_601;
            }
         }
         else if(this.var_616 == const_601)
         {
            if(this.var_1407 % 10 == 1)
            {
               this.var_1408.visible = !this.var_1408.visible;
            }
            ++this.var_1407;
         ...
         else if(this.var_616 == const_949)
         {
            this.refresh();
            this.var_616 = const_1323;
         }
         else
         {
      ...
      {
         this._navigator.refreshButton(this.var_1162,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1162,"icon_hotelview_reactive",param1,null,0);
      }
