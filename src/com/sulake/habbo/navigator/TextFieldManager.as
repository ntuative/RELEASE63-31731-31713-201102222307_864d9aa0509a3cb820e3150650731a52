package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         this.var_73.addEventListener(WindowKeyboardEvent.const_187,this.checkEnterPress);
         this.var_73.addEventListener(WindowEvent.const_102,this.checkMaxLen);
         this.var_2613 = this.var_73.textBackground;
         this._orgTextBackgroundColor = this.var_73.textBackgroundColor;
         this.var_2612 = this.var_73.textColor;
      }
      ...
      {
         this.var_73.textBackground = this.var_2613;
         this.var_73.textBackgroundColor = this._orgTextBackgroundColor;
         this.var_73.textColor = this.var_2612;
      }
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_73.text = this.var_1349;
            this.var_627 = true;
         }
         else
         {
      ...
      {
         return !this.var_627 && Util.trim(this.getText()).length > 2;
      }
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_73.text = this.var_2611;
         this.var_627 = false;
         this.restoreBackground();
      }
      ...
      private function checkMaxLen(param1:Event) : void
      {
         ...
         if(_loc2_.length > this.var_1865)
         {
            this.var_73.text = _loc2_.substring(0,this.var_1865);
         }
      }
   }
}
