package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomInfoViewCtrl implements IRoomSettingsCtrlOwner
   {
      ...
      private var var_1196:TagRenderer;
      ...
      private var var_2131:IWindowContainer;
      ...
      private var var_1570:IWindowContainer;
      
      private var var_2136:ITextWindow;
      
      private var var_683:ITextWindow;
      
      private var var_2132:IWindow;
      ...
      public function RoomInfoViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1196 = new TagRenderer(this._navigator);
      ...
      {
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_1095,HabboToolbarIconEnum.ROOMINFO,this._window,false));
      ...
      private function refreshRoom() : void
      {
         ...
         this.var_168.refresh(this.var_282);
         this.var_237.refresh(this.var_282);
         ...
         Logger.log("XORP: " + this.var_390.visible + ", " + this.var_1290.visible + ", " + this.var_682.visible + ", " + this.var_682.rectangle + ", " + this.var_282.rectangle);
      }
      ...
      private function refreshEvent() : void
      {
         ...
         this.var_328.refresh(this.var_239);
         if(Util.hasVisibleChildren(this.var_239) && !(this.var_168.active || this.var_237.active))
         {
      ...
      private function refreshEmbed() : void
      {
         ...
         if(_loc2_ && _loc1_ && !this.var_168.active && !this.var_237.active && !this.var_328.active)
         {
            this.var_855.visible = true;
            this.var_1059.text = this.getEmbedData();
         }
         else
         {
      ...
      private function refreshButtons() : void
      {
         ...
         if(this.var_1060)
         {
            if(this.var_2135 == "exit_homeroom")
            {
               this.var_1060.caption = "${navigator.homeroom}";
            }
            else
            {
               this.var_1060.caption = "${navigator.hotelview}";
            }
         }
         if(this.var_851)
         {
      ...
      {
         if(param1 == null || this.var_168.active || this.var_237.active)
         {
            return;
         }
         ...
         this.var_853.text = param1.description;
         this.var_1196.refreshTags(this.var_390,param1.tags);
         this.var_853.visible = false;
         if(param1.description != "")
         {
            this.var_853.height = this.var_853.textHeight + 5;
         ...
         Util.moveChildrenToColumn(this.var_390,["room_name","owner_name_cont","tags","room_desc","rating_cont","staff_pick_button"],this.var_825.y,0);
      ...
      private function refreshPublicSpaceDetails(param1:PublicRoomShortData) : void
      {
         ...
         this.var_1058.text = this._navigator.getPublicSpaceName(param1.unitPropertySet,param1.worldId);
         this.var_1058.height = this.var_1058.textHeight + 5;
         ...
         Util.moveChildrenToColumn(this.var_682,["public_space_name","public_space_desc"],this.var_1058.y,0);
      ...
      private function refreshEventDetails(param1:RoomEventData) : void
      {
         ...
         this.var_2136.text = param1.eventName;
         this.var_683.text = param1.eventDescription;
         this.var_1196.refreshTags(this.var_854,[this._navigator.getText("roomevent_type_" + param1.eventType),param1.tags[0],param1.tags[1]]);
         this.var_683.visible = false;
         if(param1.eventDescription != "")
         {
            this.var_683.height = this.var_683.textHeight + 5;
            this.var_683.y = Util.getLowestPoint(this.var_854) + 2;
      ...
      {
         if(this._navigator.data.enteredGuestRoom == null || this.var_168.active || this.var_237.active)
         {
            return;
         }
         this.var_1573.visible = this._navigator.data.canEditRoomSettings;
         ...
         this.var_1290.visible = Util.hasVisibleChildren(this.var_1290);
      }
      ...
      private function refreshEventButtons(param1:RoomEventData) : void
      {
         ...
         this.var_1572.visible = param1 == null && this._navigator.data.currentRoomOwner;
         this.var_1569.visible = param1 != null && (this._navigator.data.currentRoomOwner || this._navigator.data.eventMod);
         this.var_1570.visible = Util.hasVisibleChildren(this.var_1570);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_2131 = IWindowContainer(this.find("owner_name_cont"));
         this.var_2133 = IWindowContainer(this.find("rating_cont"));
         this.var_1290 = IWindowContainer(this.find("room_buttons"));
         this.var_825 = ITextWindow(this.find("room_name"));
         this.var_1058 = ITextWindow(this.find("public_space_name"));
         this._ownerName = ITextWindow(this.find("owner_name"));
         this.var_853 = ITextWindow(this.find("room_desc"));
         ...
         this.var_1570 = IWindowContainer(this.find("event_buttons"));
         this.var_2136 = ITextWindow(this.find("event_name"));
         ...
         this.var_2132 = this.find("staff_pick_button");
         this.var_1292 = IContainerButtonWindow(this.find("add_favourite_button"));
         this.var_1287 = IContainerButtonWindow(this.find("rem_favourite_button"));
         ...
         this.var_1573 = IButtonWindow(this.find("room_settings_button"));
         this.var_1572 = IButtonWindow(this.find("create_event_button"));
         this.var_1569 = IButtonWindow(this.find("edit_event_button"));
         this.var_855 = IWindowContainer(this.find("embed_info"));
         this.var_1293 = ITextWindow(this.find("embed_info_txt"));
         this.var_1059 = ITextFieldWindow(this.find("embed_src_txt"));
         this.var_66 = IWindowContainer(this.find("buttons_container"));
         this.var_1060 = IButtonWindow(this.find("exit_room_button"));
         this.var_851 = IButtonWindow(this.find("zoom_button"));
         Util.setProcDirectly(this.var_1292,this.onAddFavouriteClick);
         Util.setProcDirectly(this.var_1287,this.onRemoveFavouriteClick);
         Util.setProcDirectly(this.var_1573,this.onRoomSettingsClick);
         Util.setProcDirectly(this.var_1286,this.onMakeHomeClick);
         Util.setProcDirectly(this.var_1294,this.onUnmakeHomeClick);
         Util.setProcDirectly(this.var_1572,this.onEventSettingsClick);
         Util.setProcDirectly(this.var_1569,this.onEventSettingsClick);
         Util.setProcDirectly(this.var_1059,this.onEmbedSrcClick);
         Util.setProcDirectly(this.var_1291,this.onThumbUp);
         Util.setProcDirectly(this.var_2132,this.onStaffPick);
         Util.setProcDirectly(this.var_1288,this.onFacebookLike);
         Util.setProcDirectly(this.var_851,this.onZoomClick);
         Util.setProcDirectly(this.var_1060,this.onExitRoomClick);
         ...
         Util.moveChildrenToRow(this.var_2131,["owner_caption","owner_name"],this.var_1057.x,this.var_1057.y,3);
         this.var_852.width = this.var_852.textWidth;
         Util.moveChildrenToRow(this.var_2133,["rating_caption","rating_txt"],this.var_852.x,this.var_852.y,3);
         this.var_1293.height = this.var_1293.textHeight + 5;
         Util.moveChildrenToColumn(this.var_855,["embed_info_txt","embed_src_txt"],this.var_1293.y,2);
      ...
      private function onEmbedSrcClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1059.setSelection(0,this.var_1059.text.length);
      }
      ...
      private function onToolbarIconState(param1:HabboToolbarSetIconEvent) : void
      {
         ...
         switch(param1.iconId)
         {
            case HabboToolbarIconEnum.ZOOM:
               this.var_2134 = param1.iconState;
               this.refreshButtons();
               break;
            case HabboToolbarIconEnum.EXITROOM:
               this.var_2135 = param1.iconState;
               this.refreshButtons();
         }
      }
