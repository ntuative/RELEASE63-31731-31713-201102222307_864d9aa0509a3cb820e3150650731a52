package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1687:uint = 4.293848814E9;
      
      private const const_1688:uint = 4.294967295E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1524 = _loc1_.stuffTypes;
            this.var_663 = _loc1_.boxTypes;
            this.var_664 = _loc1_.ribbonTypes;
            this.var_1016 = this.var_1524[0];
            this.var_322 = this.var_663[0];
            this.var_323 = this.var_664[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_323 < 0)
         {
            this.var_323 = this.var_664.length - 1;
         }
         if(this.var_323 > this.var_664.length - 1)
         {
            this.var_323 = 0;
         }
         if(this.var_322 < 0)
         {
            this.var_322 = this.var_663.length - 1;
         }
         if(this.var_322 > this.var_663.length - 1)
         {
            this.var_322 = 0;
         }
         var _loc1_:int = this.var_663[this.var_322] * 1000 + this.var_664[this.var_323];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_91.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1016,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1261 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1524;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1016);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_663[this.var_322]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_664[this.var_323]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_91,this.var_1262,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_91.offerId,this.var_1262);
               this.dispose();
               break;
            case "cancel_button":
      ...
      {
         if(this.var_233 == null || !this.var_233.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_233.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_233 == null)
         {
            this.var_233 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_547 == null)
         {
         ...
         if(this.var_233 == null || this.var_547 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_233.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(this.const_1687) : uint(this.const_1688);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_233.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1016;
               }
            }
            _loc4_++;
         }
