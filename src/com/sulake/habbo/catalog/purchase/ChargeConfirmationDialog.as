package com.sulake.habbo.catalog.purchase
{
   ...
   public class ChargeConfirmationDialog implements IDisposable
   {
      ...
      private var var_722:ChargeInfo;
      ...
      public function refresh() : void
      {
         ...
         {
            this.showChargeInfo(this.var_722);
         }
      }
      ...
      public function showChargeInfo(param1:ChargeInfo) : void
      {
         ...
         this._catalog.windowManager.registerLocalizationParameter("catalog.charge.currentamount","charges","" + this.var_722.charges);
         var _loc2_:BalanceAndCost = new BalanceAndCost(this._catalog,this._localization,new ChargeOffer(this.var_722));
         ...
         this._catalog.windowManager.registerLocalizationParameter("catalog.charge.info","patch_size","" + this.var_722.chargePatchSize);
      ...
      private function onCharge(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._catalog.connection.send(new UseFurnitureMessageComposer(this.var_722.stuffId,2));
      }
