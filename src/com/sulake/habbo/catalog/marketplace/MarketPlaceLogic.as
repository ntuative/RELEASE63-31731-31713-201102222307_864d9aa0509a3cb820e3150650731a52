package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1905:int = 1;
      
      public const const_1853:int = 2;
      
      public const const_2002:int = 3;
      ...
      private var var_2289:MarketplaceItemStats;
      ...
      {
         this.requestOffers(this.var_2283,this.var_2287,this.var_2288,this.var_2286);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_1905,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_571)
            {
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2281 = _loc3_.creditsWaiting;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_1853,updateItem);
            this._visualization.listUpdatedNotify();
         }
      ...
      {
         if(param1.method_2 != this.var_2285 || param1.furniTypeId != this.var_2284)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1277)
               {
                  _loc2_ = true;
               }
            }
