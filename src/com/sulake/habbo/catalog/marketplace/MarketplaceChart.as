package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         this.var_895 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_895);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_895 - 1) / 5 * _loc10_;
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1120,(param2 - this.var_895) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1120 + this.var_1120 / -this.var_2770 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_895 - this.var_895 / this.var_587 * this.var_151[param1];
      }
