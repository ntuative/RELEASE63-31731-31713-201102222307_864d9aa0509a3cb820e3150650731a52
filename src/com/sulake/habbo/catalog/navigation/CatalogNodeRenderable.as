package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1328:XML;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1328 == null)
         {
            ...
            var_1328 = _loc4_.content as XML;
         }
         if(var_1330 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1625;
            }
         }
      }
      ...
      {
         this.var_56 = navigator.catalog.windowManager.buildFromXML(var_1330) as IItemListWindow;
         if(this.var_56 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1328) as IWindowContainer;
         }
         else
         {
