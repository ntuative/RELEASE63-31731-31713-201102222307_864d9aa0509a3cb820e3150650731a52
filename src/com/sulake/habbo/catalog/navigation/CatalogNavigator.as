package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2796:String = "magic.credits";
      
      private var var_2756:String = "magic.pixels";
      
      private var var_2755:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2756);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2755,true);
      }
