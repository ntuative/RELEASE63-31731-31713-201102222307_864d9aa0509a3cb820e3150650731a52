package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_622[this.var_1189][this.var_1854];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1189 = var_1001.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_1189];
         var _loc3_:Array = this.var_622[this.var_1189] as Array;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_501 || _loc1_.pricingModel == Offer.const_563)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_82 || _loc3_.productType == ProductTypeEnum.const_92)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(this._groupNames.indexOf(_loc5_) == -1)
                        {
                           ...
                           this.var_622.push(new Array());
                        }
                        _loc6_ = this._groupNames.indexOf(_loc5_);
                        (this.var_622[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
