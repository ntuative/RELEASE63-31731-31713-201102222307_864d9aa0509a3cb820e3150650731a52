   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_721,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_312,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_880,this.deActivateScrollbar);
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_983 == page.offers.length)
            {
         ...
         while(_loc3_ < 3)
         {
            if(this.var_983 >= 0 && this.var_983 < page.offers.length)
            {
               _loc4_ = page.offers[this.var_983];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_488)
         {
            ++this.var_1918;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1918);
         }
      }
