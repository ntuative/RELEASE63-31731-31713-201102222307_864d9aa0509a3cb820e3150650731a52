package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         events.addEventListener(WidgetEvent.const_759,this.onApproveNameResult);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(this.var_491 < 0 || this.var_491 > this.var_342.length)
         {
            this.var_491 = 0;
         }
         this.updateImage();
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_197 == null || this.var_721 >= this.var_197.length)
         {
            return;
         }
         var _loc2_:* = 0;
         if(this.var_491 >= 0 && this.var_491 < this.var_342.length)
         {
            _loc7_ = this.var_342[this.var_491] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:int = this.var_197[this.var_721] as int;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(this.var_509,_loc3_,_loc2_,AvatarScaleType.const_56,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_285,AvatarAction.const_699);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_491 >= this.var_342.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_342[this.var_491] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:int = this.var_197[this.var_721] as int;
