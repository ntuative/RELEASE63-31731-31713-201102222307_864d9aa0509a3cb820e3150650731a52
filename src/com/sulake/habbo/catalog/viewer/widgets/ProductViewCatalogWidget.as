package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1582:Point;
      
      private var var_472:IItemGridWindow;
      
      private var var_1302:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_860 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1069 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1582 = new Point(this.var_85.x,this.var_85.y);
         this.var_472 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1302 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_472 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1879 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         this.var_1581 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_860.text = _loc4_;
         this.var_1069.text = _loc5_;
         this.var_860.height = this.var_860.textHeight + 5;
         this.var_1069.y = this.var_860.y + this.var_860.height;
         this.var_1069.height = Math.max(130,this.var_1069.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_488:
                  _loc6_ = this.var_1581.clone();
                  if(this.var_472 != null)
                  {
                     this.var_472.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_472,this.var_1302,this.var_1879);
                     this.var_472.scrollV = 0;
                  }
                  break;
               case Offer.const_501:
               case Offer.const_563:
                     ...
                     case ProductTypeEnum.const_268:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_285,AvatarAction.const_427);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2151)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_85 != null && true)
         {
            ...
            this.var_85.x = this.var_1582.x;
            this.var_85.y = this.var_1582.y;
            if(param3 != null)
            {
