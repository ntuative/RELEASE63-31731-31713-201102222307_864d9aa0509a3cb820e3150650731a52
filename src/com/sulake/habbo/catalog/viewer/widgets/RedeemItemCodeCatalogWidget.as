package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_985.removeEventListener(WindowKeyboardEvent.const_187,this.windowKeyEventProcessor);
            this.var_985 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_985 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_985 != null)
         {
            this.var_985.addEventListener(WindowKeyboardEvent.const_187,this.windowKeyEventProcessor);
         }
         return true;
      }
