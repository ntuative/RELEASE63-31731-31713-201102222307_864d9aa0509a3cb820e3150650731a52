package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1657:String = "ctlg_";
       
      
      protected var var_1983:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1197:ICatalogViewer;
      ...
      {
         var _loc2_:String = const_1657 + param1;
         ...
         this.var_1983 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1983) as IWindowContainer;
         if(this._window == null)
         {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1526:
               if(this.var_1146 == null)
               {
                  ...
                  this.var_48.push(this.var_1146);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1633:
               ...
               break;
            case CatalogWidgetEnum.const_1410:
            ...
            case CatalogWidgetEnum.const_1383:
               ...
               break;
            case CatalogWidgetEnum.const_1376:
            ...
            case CatalogWidgetEnum.const_1431:
               ...
               break;
            case CatalogWidgetEnum.const_1378:
