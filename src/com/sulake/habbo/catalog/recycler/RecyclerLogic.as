package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_574 != const_926;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1635 != RecyclerStatusMessageEvent.const_1131;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_574 == const_416;
      }
      ...
      {
         this.var_574 = const_925;
         this.var_108 = new Array(const_197);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1445:
               this.var_574 = const_416;
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1202:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1649:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_108.length < const_197)
         {
            return false;
         }
         var _loc1_:int = 0;
