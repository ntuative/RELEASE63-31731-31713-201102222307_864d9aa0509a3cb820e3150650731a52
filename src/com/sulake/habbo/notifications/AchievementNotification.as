package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1971:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this._window.center();
         this.var_2316 = this.var_80.getBadgeName(this.var_292);
         this.var_2314 = this.var_80.getBadgeDesc(this.var_292);
         this.var_2313 = this.var_80.getAchievementNameForFacebook(this.var_292,this.var_405.userName,this.var_405.realName,this.var_1338);
         this.var_2318 = this.var_80.getAchievementDescForFacebook(this.var_292,this.var_405.userName,this.var_405.realName,this.var_1338);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2312 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_80.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1847.toString());
         this.var_80.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1339.toString());
         this.var_80.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1339.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1667;
         var _loc17_:String = this.var_1667 == 0 ? "pixels" : "activitypoints";
         this.var_80.registerParameter(_loc16_,_loc17_,"" + this.var_2317);
         _loc15_.caption = this.var_80.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1667);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1971) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this.var_80.registerParameter(param1,"badge_name",this.var_2316);
         this.var_80.registerParameter(param1,"badge_desc",this.var_2314);
         this.var_80.registerParameter(param1,"badge_name_fb",this.var_2313);
         this.var_80.registerParameter(param1,"badge_desc_fb",this.var_2318);
         this.var_80.registerParameter(param1,"level",this.var_1338.toString());
         this.var_80.registerParameter(param1,"name",this.var_405.userName);
         return this.var_80.registerParameter(param1,"realname",this.var_405.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_405.events.removeEventListener(BadgeImageReadyEvent.const_149,this.onBadgeImageReady);
            this.var_405 = null;
         }
         if(this._window != null)
         {
      ...
      {
         HabboWebTools.facebookAchievementPost(this.var_292,this._feedTitleFb,this.var_2312,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2315));
