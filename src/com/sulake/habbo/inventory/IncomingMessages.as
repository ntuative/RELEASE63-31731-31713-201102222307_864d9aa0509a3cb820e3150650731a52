package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_.getSelectedItemIndex(FurniModel.const_50) == -1)
         {
            _loc4_.toggleItemSelection(FurniModel.const_50,0);
         }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_802);
         _loc2_.refreshViews();
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_133);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_389);
         var _loc4_:FurniModel = this._inventory.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
      ...
      private function onMarketplaceItemStats(param1:MarketplaceItemStatsEvent) : void
      {
         ...
         _loc3_.setAveragePrice(_loc2_.method_2,_loc2_.furniTypeId,_loc2_.averagePrice);
      }
      ...
      {
         var _loc2_:* = null;
         if(this._inventory.isInventoryCategoryInit(InventoryCategory.const_389))
         {
