package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2748:BitmapData;
      
      private const const_1965:int = 8947848;
      
      private const const_1964:int = 13421772;
      
      private const const_1683:Number = 1;
      
      private const const_1682:Number = 0.2;
      ...
      public function initImage() : void
      {
         ...
         if(this._mainCategory == FurniModel.const_45)
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1243));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1969);
         }
         if(_loc1_.id > 0)
         {
            this.setLoadingImage(_loc1_.data);
            this.var_804 = _loc1_.id;
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1682;
               _loc1_.blend = this.const_1682;
            }
            else
            {
               this._window.blend = this.const_1683;
               _loc1_.blend = this.const_1683;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1985 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2748;
               _loc5_.visible = true;
            }
            else
            {
