   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_503,this.roomSessionEventHandler);
      ...
      {
         return TradingModel(this.var_49.getValue(InventorySubCategory.const_300));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_49.getValue(InventoryCategory.const_802));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_49.getValue(InventoryCategory.const_298));
      }
      ...
      {
         return PetsModel(this.var_49.getValue(InventoryCategory.const_133));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_49.getValue(InventoryCategory.const_389) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_503,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_98:
               this.var_1002 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_503:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_405 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_182)
         {
            return;
         }
         this._view = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this._view.setToolbar(this.var_182);
         this.var_49 = new Map();
         ...
         this.var_49.add(InventoryCategory.const_389,_loc1_);
         ...
         this.var_49.add(InventoryCategory.const_298,_loc3_);
         ...
         this.var_49.add(InventoryCategory.const_802,_loc4_);
         ...
         this.var_49.add(InventoryCategory.const_350,_loc5_);
         ...
         this.var_49.add(InventorySubCategory.const_300,_loc6_);
         ...
         this.var_49.add(InventoryCategory.const_133,_loc8_);
         this.var_185 = true;
         if(this.var_1998)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_809.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_809.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_809.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_809.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1945);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_724));
      }
