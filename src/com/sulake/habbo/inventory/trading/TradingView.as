package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_939:uint = 2577770;
      ...
      private var var_413:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_413 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_67)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_938) : uint(const_939);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_938) : uint(const_939);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1083)
            {
            ...
            this.var_413.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_426);
            this.var_413.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_413.hideDelayed();
         }
      }
