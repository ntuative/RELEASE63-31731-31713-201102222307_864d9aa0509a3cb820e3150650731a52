package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1639:uint = 9;
      
      public static const const_200:uint = 0;
      
      public static const const_186:uint = 1;
      
      public static const const_379:uint = 2;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_54.updateItemList(this.var_675);
         this.var_54.updateItemList(this.var_1278);
      ...
      public function close() : void
      {
         if(this.var_765)
         {
            if(this._state != const_200 && this._state != const_251)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_674 + " OTHER: " + this.var_1041);
         ...
         {
            case const_200:
               if(param1 == const_186 || param1 == const_251)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_54.alertPopup(TradingView.const_1153);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_675)
            {
               this.var_674 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1041 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_54.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_675)
            {
               this.var_54.alertPopup(TradingView.const_1059);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_279.length < const_1639)
         {
