package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1041,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_761,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_682,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1109)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1657;
            if(_loc2_ - this.var_1109 >= this.var_1658)
            {
               _loc3_ = this.var_1108;
               _loc4_ = this.var_1655;
               this.var_1109 = 0;
            }
            else
            {
               _loc7_ = this.var_1336 >> 16 & 255;
               _loc8_ = this.var_1336 >> 8 & 255;
               _loc9_ = this.var_1336 & 255;
               _loc10_ = this.var_1108 >> 16 & 255;
               _loc11_ = this.var_1108 >> 8 & 255;
               _loc12_ = this.var_1108 & 255;
               _loc13_ = (_loc2_ - this.var_1109) / this.var_1658;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1656 + (this.var_1655 - this.var_1656) * _loc13_;
               this._color = _loc3_;
               this.var_1657 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_761,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_793:
               param2.setString(RoomObjectVariableEnum.const_782,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_778:
               param2.setString(RoomObjectVariableEnum.const_631,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_547:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_238)
               {
                  _loc5_ = "null";
               }
               this.var_478.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_642:
               _loc4_ = this.var_478.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_478.getXML();
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1208:
               param2.setNumber(RoomObjectVariableEnum.const_682,_loc3_);
               break;
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1336 = this._color;
         this.var_1656 = this.var_1657;
         this.var_1108 = _loc3_;
         this.var_1655 = _loc4_;
         this.var_1109 = getTimer();
         this.var_1658 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1577,_loc20_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_198)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_167 || _loc13_ == RoomPlaneData.const_305)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
