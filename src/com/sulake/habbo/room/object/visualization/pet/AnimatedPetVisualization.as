package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_606:int = 1;
      
      private static const const_958:int = 1000;
      
      private static const const_1332:String = "pet_experience_bubble_png";
      
      private static const const_1333:int = 0;
      
      private static const const_1334:int = 1;
      ...
      private var var_276:AnimatedPetVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_276 = param1 as AnimatedPetVisualizationData;
         var _loc2_:* = null;
         if(this.var_276.commonAssets != null)
         {
            _loc3_ = this.var_276.commonAssets.getAssetByName(const_1332) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_337);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_250);
            this.validateActions(_loc4_,_loc5_);
            this._isSleeping = _loc3_.getNumber(RoomObjectVariableEnum.const_371) > 0;
            this.var_1706 = _loc3_.getNumber(RoomObjectVariableEnum.const_316);
            this.var_1354 = _loc3_.getNumber(RoomObjectVariableEnum.const_879);
            this.var_2056 = _loc3_.getNumber(RoomObjectVariableEnum.const_872);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
            if(_loc6_ != this.var_1876)
            {
               this.var_1876 = _loc6_;
               this.var_2641 = this.var_1876.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this._experienceData != null)
         {
            ...
            if(this.var_1354 > 0)
            {
               _loc2_ = param1 - this.var_1354;
               if(_loc2_ < const_958)
               {
                  this._experienceData.alpha = int(Math.sin(_loc2_ / const_958 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         {
            this.var_253 = param1;
            _loc3_ = this.var_276.getAnimationForPosture(var_186,param1);
            this.setAnimationForIndex(const_1333,_loc3_);
         }
         if(param2 != this.var_1355)
         {
            this.var_1355 = param2;
            _loc3_ = this.var_276.getAnimationForGesture(var_186,param2);
      ...
      {
         return super.getAdditionalSpriteCount() + const_606;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2641);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_606)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_606))
            {
               if(_data == null || param2 >= FurnitureVisualizationData.const_422.length)
               {
                  return null;
               }
