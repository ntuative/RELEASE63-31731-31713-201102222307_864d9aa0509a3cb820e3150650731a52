package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_1600:Boolean = true;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_586 != spriteCount)
         {
            createSprites(this.var_586);
         }
         var _loc4_:Boolean = false;
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_447 != _loc3_.getUpdateID() || param1 != var_186 || param2 != this.var_2739)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2740 = _loc3_.getNumber(RoomObjectVariableEnum.const_229);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_291));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1230 = _loc3_.getString(RoomObjectVariableEnum.const_332);
            if(this.var_1230 == null || this.var_1230.indexOf("http") != 0)
            {
               this.var_1230 = null;
            }
      ...
      {
         if(this.var_2192 != param2 || this.var_2190 != param1)
         {
            this.var_868 = [];
            this.var_867 = [];
            this.var_695 = [];
            ...
            this.var_2191 = this.getSize(param1);
            this.var_586 = this._data.getLayerCount(param1) + this.getAdditionalSpriteCount();
            this.var_1599 = this.var_586 - this.getAdditionalSpriteCount();
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc3_:String = this.var_868[param2];
         var _loc4_:Boolean = this.var_867[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2191;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1599)
            {
      ...
      {
         if(this.var_691[param3] != null && !this.var_1600)
         {
