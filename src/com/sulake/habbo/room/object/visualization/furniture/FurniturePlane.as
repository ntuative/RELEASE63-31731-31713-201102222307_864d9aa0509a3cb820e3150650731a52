package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      {
         if(param1 != this.var_2267)
         {
            if(!param1)
            {
               this.var_289.assign(this.var_709);
               this.var_290.assign(this.var_710);
            }
            else
            {
               this.var_289.assign(this.var_709);
               this.var_289.mul(this.var_710.length / this.var_709.length);
               this.var_290.assign(this.var_710);
               this.var_290.mul(this.var_709.length / this.var_710.length);
            }
            this.var_1640 = -1;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1))
         {
            ...
            _loc6_ = Number(this.var_290.length * param1.scale);
            if(_loc5_ < 1)
            {
               _loc5_ = 1;
            }
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_81 == null && this.var_1103 != null || this.var_289 == null || this.var_290 == null || this.var_576 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1640)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1326 || _loc4_.y != this.var_2235 || _loc4_.z != this.var_2233 || param1.scale != this.var_2232))
            {
               this.var_1326 = _loc4_.x;
               this.var_2235 = _loc4_.y;
               this.var_2233 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1103);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_147.z - _loc7_,this.var_110.z - _loc7_,this.var_86.z - _loc7_,this.var_109.z - _loc7_);
               this.var_2266 = _loc8_;
