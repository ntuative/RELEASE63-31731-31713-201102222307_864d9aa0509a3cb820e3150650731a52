package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_207:FurnitureParticleSystem;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_207 = this.var_550[param1];
               _loc3_ = true;
            }
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_207)
         {
            this.var_207.setAnimation(param1);
         }
      ...
      {
         if(this.var_207 && this.var_207.controlsSprite(param3))
         {
            return this.var_207.getSpriteYOffset(param1,param2,param3);
         }
