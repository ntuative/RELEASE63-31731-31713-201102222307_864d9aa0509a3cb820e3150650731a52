package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_952:int = 15;
      ...
      private function getNewPoint(param1:Number, param2:int) : Point
      {
         ...
         var _loc4_:int = this.var_1171[param2];
         var _loc5_:int = this.var_1174[param2];
         var _loc6_:Number = this.var_1172[param2];
         if(param1 == 32)
         {
            _loc7_ = const_952;
         }
         ...
         if(int(_loc9_) == 0)
         {
            this.var_1172[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1171.push(1);
         this.var_1171.push(-1);
         this.var_1174 = new Array();
         this.var_1174.push(const_1324);
         this.var_1174.push(ANIM_SPEED_SLOW);
         this.var_1172 = new Array();
         this.var_1172.push(this.getRandomAmplitudeFactor());
         this.var_1172.push(this.getRandomAmplitudeFactor());
      }
