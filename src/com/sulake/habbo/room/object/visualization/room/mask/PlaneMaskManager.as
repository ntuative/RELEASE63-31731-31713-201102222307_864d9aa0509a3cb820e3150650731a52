package com.sulake.habbo.room.object.visualization.room.mask
{
   ...
   public class PlaneMaskManager
   {
      ...
      private var var_766:IGraphicAssetCollection = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_173 != null)
         {
            ...
            {
               _loc2_ = this.var_173.getWithIndex(_loc1_) as PlaneMask;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function initializeAssetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         this.var_766 = param1;
         this.include(this.data,param1);
      }
      
      private function include(param1:XML, param2:IGraphicAssetCollection) : void
      {
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc9_:* = null;
         ...
         while(_loc6_ < _loc5_.length())
         {
            ...
            {
               _loc8_ = _loc7_.@id;
               if(this.var_173.getValue(_loc8_) == null)
               {
                  ...
                  this.var_173.add(_loc8_,_loc9_);
               }
            }
            _loc6_++;
         }
      ...
      public function updateMask(param1:BitmapData, param2:String, param3:Number, param4:IVector3d, param5:int, param6:int) : Boolean
      {
         ...
         var _loc15_:* = NaN;
         var _loc16_:* = NaN;
         var _loc7_:PlaneMask = this.var_173.getValue(param2) as PlaneMask;
         if(_loc7_ != null)
         {
