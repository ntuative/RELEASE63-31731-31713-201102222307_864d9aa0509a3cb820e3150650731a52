package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1493:int = const_401;
      ...
      public static const const_287:int = const_115;
      ...
      private var var_745:Vector3d = null;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1.0, param5:Number = 1.0, param6:Number = -1.0, param7:Number = 1.0)
      {
         ...
         this.var_2010 = param6;
         this.var_2012 = param7;
         this.var_745 = new Vector3d();
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_745 != null)
         {
            this.var_745.assign(new Vector3d());
         }
         this.var_608 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_358.length)
         {
            _loc2_ = this.var_358[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= this.var_358.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = this.var_358[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_358[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.width == param2 && this.var_30.height == param3 && Vector3d.isEqual(this.var_745,param4))
               {
                  if(param1 != null)
                  {
         ...
         {
            _loc11_ = this.var_358[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1778 == const_115)
         {
            _loc5_ = new Rectangle(0,0,this.var_30.width,this.var_608);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_30.height - this.var_608,this.var_30.width,this.var_608);
         }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(this.var_358.length == 1)
         {
            _loc4_ = this.var_358[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
