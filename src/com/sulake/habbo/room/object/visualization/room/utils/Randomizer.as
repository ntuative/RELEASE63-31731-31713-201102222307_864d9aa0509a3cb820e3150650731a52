package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1923:int = 16777216;
      ...
      private var var_1795:int = 16777216;
      
      private var var_2775:int = 69069;
      
      private var var_2774:int = 5;
      ...
      {
         var _loc1_:int = this.var_2775 * this.var_1796 + this.var_2774;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1795;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1795 * param2);
      }
   }
}
