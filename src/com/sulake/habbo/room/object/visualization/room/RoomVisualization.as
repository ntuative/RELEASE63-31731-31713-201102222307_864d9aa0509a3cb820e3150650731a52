package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1603:int = 13421772;
      
      private static const const_922:int = 16777215;
      
      private static const const_924:int = 13421772;
      
      private static const const_921:int = 10066329;
      
      private static const const_923:int = 10066329;
      
      public static const const_1364:int = 16777215;
      
      public static const const_1638:int = 13421772;
      
      public static const const_1563:int = 10066329;
      ...
      private var var_702:Rectangle = null;
      
      private var var_478:RoomPlaneBitmapMaskParser = null;
      
      private var var_1551:String = null;
      
      private var _floorType:String = null;
      
      private var var_1554:String = null;
      
      private var var_2236:String = null;
      
      private var var_1088:uint = 16777215;
      
      private var var_2238:int = 255;
      
      private var var_2237:int = 255;
      
      private var var_2234:int = 255;
      ...
      private const const_1966:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_478 = new RoomPlaneBitmapMaskParser();
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_702 = super.boundingRectangle;
         }
         return new Rectangle(this.var_702.x,this.var_702.y,this.var_702.width,this.var_702.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1041);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1018);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_198)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1471)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_113,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1966 && !_loc5_ && !_loc7_)
         {
            return;
         }
            ...
            while(_loc9_ < this.var_337.length)
            {
               ...
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_94)
               {
                  if(this.var_1619)
                  {
                     ...
                     _loc14_ = uint((_loc13_ & 255) * this.var_2234 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2237 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2238 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1640)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1326 || _loc3_.y != this.var_2235 || _loc3_.z != this.var_2233 || param1.scale != this.var_2232))
            {
               this.var_1326 = _loc3_.x;
               this.var_2235 = _loc3_.y;
               this.var_2233 = _loc3_.z;
               this.var_2232 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_165 != param1.getUpdateID())
         {
            ...
            if(_loc3_ != this.var_2236)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2236 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_761));
            if(_loc4_ != this.var_1088)
            {
               this.var_1088 = _loc4_;
               this.var_2234 = this.var_1088 & 255;
               this.var_2237 = this.var_1088 >> 8 & 255;
               this.var_2238 = this.var_1088 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1149));
            if(_loc5_ != this.var_1619)
            {
               this.var_1619 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_165 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_631);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_782);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_865);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_682));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_678));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_732));
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1618;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_478.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_478.maskCount)
         {
            _loc10_ = this.var_478.getMaskType(_loc8_);
            _loc11_ = this.var_478.getMaskLocation(_loc8_);
            _loc12_ = this.var_478.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_126.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_113 || _loc3_.type == RoomPlane.const_94)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_113 || _loc3_.type == RoomPlane.const_94 && _loc12_ == RoomPlaneBitmapMaskData.const_238)
                              {
