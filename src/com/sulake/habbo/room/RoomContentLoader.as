package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_613:String = "RCL_LOADER_READY";
      ...
      private static const const_930:String = "selection_arrow";
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2319 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2321 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2320 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2323 = param2.getKey("public.room.dynamic.download.url","");
      ...
      private function initPetData() : void
      {
         ...
         for each(_loc3_ in _loc1_)
         {
            ...
            this.var_888.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_486 != null)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_486.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_714.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_408.add(_loc3_,_loc4_);
            ...
            else if(_loc2_.type == "i")
            {
               ...
               this.var_584.add(_loc3_,_loc4_);
      ...
      private function continueInitilization() : void
      {
         if(this.var_2322)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_613));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_485 != null)
         {
            this.var_485.remove(param2);
            this.var_485.add(param2,param1);
         }
      }
      ...
      {
         return [const_417,const_595,const_597,const_596,TILE_CURSOR,const_930];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_408.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_584.getValue(param1) as String;
      ...
      {
         return this.var_888.getValue(param1) as String;
      }
      ...
      {
         var _loc2_:String = this.var_584.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      {
         if(this.var_196 != null && this.var_196.hasWorldType(const_328 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_176 || param1 == RoomObjectVisualizationEnum.const_68 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2323 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1340.getValue(param1) != null)
         {
            this.var_196 = this.var_1340.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_844,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2319.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1340.add(param1,_loc4_);
         this.var_196 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_715.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_715.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_715.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_247 && _loc5_ != RoomObjectLogicEnum.const_176)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_528.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_196.getWorldHeightScale(const_328 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_196 != null)
         {
            return this.var_196.getWorldScale(const_328 + param1);
         }
         return 32;
      }
      ...
      {
         this.var_408.remove(param1);
         this.var_408.add(param1,param2);
      }
   }
}
