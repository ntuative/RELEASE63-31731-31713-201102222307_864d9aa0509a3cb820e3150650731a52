package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1265:uint = 1;
      ...
      private var var_865:IWindowRenderer;
      
      private var var_864:ISkinContainer;
      
      private var var_332:Array;
      
      private var var_1306:IEventDispatcher;
      
      private var var_1074:Boolean = false;
      
      private var var_1590:ProfilerOutput;
      
      private var var_1305:ProfilerAgentTask;
      
      private var var_1307:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_864 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_865 = new WindowRenderer(this.var_864);
         this.var_194 = new Array(const_414);
         ...
         {
            this.var_194[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_865,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_194[const_1265];
         ...
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1407,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1590)
            {
               this.var_1590 = new ProfilerOutput(context,this,this.var_865);
            }
            this.var_1590.profiler = _loc3_;
            ...
            this.var_1307 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1307);
            this.var_1074 = true;
         }
      }
      ...
      {
         return this.var_864.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1306.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_414 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1306.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         this.var_1306.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1385,new Date().getTime().toString());
            ...
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1425,param2.name + ": " + param2.toString());
            }
         }
      }
