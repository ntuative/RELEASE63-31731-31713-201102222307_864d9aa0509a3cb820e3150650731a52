package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1699:TriggerConfs;
      
      private var var_1701:ActionTypes;
      
      private var var_1700:ConditionTypes;
      
      private var var_247:Dictionary;
      
      private var var_35:Triggerable;
      
      private var var_724:RoomObjectHightLighter;
      
      private var var_177:UserDefinedRoomEventsHelp;
      
      private var var_1122:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1699 = new TriggerConfs();
         this.var_1701 = new ActionTypes();
         this.var_1700 = new ConditionTypes();
         this.var_247 = new Dictionary();
         super();
         this.var_78 = param1;
         this.var_724 = new RoomObjectHightLighter(param1);
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1122 = new SliderWindowController(this.var_78,IWindowContainer(this.find(this.var_50,"delay_slider_container")),this.var_78.assets,0,20,1);
         this.var_1122.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1122.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_724.hideAll(this.var_247);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_724.showAll(this.var_247);
         if(this.var_35 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_35);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1122.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1122.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = this.var_35.stuffTypeSelectionCode < 1 ? int(var_1352) : int(this.var_35.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = (this.var_35.stuffTypeSelectionCode + 1) % (var_1352 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1699);
         this.refreshConfigureElement(this.var_1701);
         this.refreshConfigureElement(this.var_1700);
