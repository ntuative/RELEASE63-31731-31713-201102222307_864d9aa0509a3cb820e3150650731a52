package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_1042:IHabboWindowManager;
      ...
      private var var_554:FramerateTracker = null;
      
      private var var_236:LatencyTracker = null;
      
      private var var_553:LagWarningLogger = null;
      
      private var var_555:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_554 = new FramerateTracker();
         this.var_236 = new LatencyTracker();
         this.var_553 = new LagWarningLogger();
         this.var_555 = new ToolbarClickTracker(this);
         this.var_1279 = new Array(const_913);
         var _loc4_:int = 0;
         while(_loc4_ < const_913)
         {
            this.var_1279[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1362,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1508,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_697,String(false));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1042)
            {
               this.var_1042.release(new IIDHabboWindowManager());
               this.var_1042 = null;
            }
            if(this.var_301)
            {
            ...
            if(this.var_190)
            {
               if(!this.var_190.disposed)
               {
                  ...
                  Component(this.var_190).events.removeEventListener(HabboFriendListTrackingEvent.const_351,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_182)
            {
               ...
               {
                  this.var_182.events.removeEventListener(HabboToolbarEvent.const_38,this.onToolbarClick);
               }
      ...
      {
         this.var_1279[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_167 = IHabboConfigurationManager(param2);
         if(this.var_167)
         {
            if(this.var_236 != null)
            {
               this.var_236.configuration = this.var_167;
            }
            if(this.var_235 != null)
            {
               this.var_235.configuration = this.var_167;
            }
            ...
            if(this.var_167)
            {
               ...
               {
                  this.var_553.configure(this.var_167);
               }
               if(this.var_554 != null)
               {
                  this.var_554.configure(this.var_167);
               }
               if(this.var_555 != null)
               {
                  this.var_555.configure(this.var_167);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_774,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_172,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_483,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_553 != null)
            {
               this.var_553.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         else if(param1.type == HabboHotelViewEvent.const_483)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1491);
         }
         else if(param1.type == HabboHotelViewEvent.const_72)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1403);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1454);
               break;
            case HabboCommunicationEvent.const_774:
               this.trackLoginStep(HabboLoginTrackingStep.const_1651,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_172:
               this.trackLoginStep(HabboLoginTrackingStep.const_172);
               break;
      ...
      {
         this.var_1042 = IHabboWindowManager(param2);
         if(this.var_1042)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_167)
            {
               if(this.var_167.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_167.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1279)
                  {
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_190).events.addEventListener(HabboFriendListTrackingEvent.const_351,this.onFriendlistTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_697,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_301.events.addEventListener(AdEvent.const_443,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_182 = param2 as IHabboToolbar;
         this.var_182.events.addEventListener(HabboToolbarEvent.const_38,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_555)
         {
            this.var_555.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_167 != null && !Boolean(this.var_167.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_553.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_464 > -1 && _loc2_ < this.var_464)
         {
            ++this.var_1555;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1555);
         }
         if(this.var_464 > -1 && _loc2_ - this.var_464 > 15000)
         {
            ++this.var_1556;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1556);
         }
         this.var_464 = _loc2_;
         if(this.var_235 != null)
         {
            this.var_235.update(param1,this.var_464);
         }
         if(this.var_236 != null)
         {
            this.var_236.update(param1,this.var_464);
         }
         if(this.var_554 != null)
         {
            this.var_554.trackUpdate(param1,this,this.var_464);
         }
         if(this.var_553 != null)
         {
            this.var_553.update(this.var_464);
         }
      }
   }
}
