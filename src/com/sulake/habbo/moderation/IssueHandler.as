package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_140:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_452:UserInfoCtrl;
      
      private var var_1008:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.setProc("release",this.method_4);
         ...
         var _loc3_:IssueMessageData = this.var_140.getHighestPriorityIssue();
         this.var_452 = new UserInfoCtrl(this._window,this.var_62,_loc3_.message);
         this.var_1008 = new UserInfoCtrl(this._window,this.var_62,_loc3_.message);
         this.var_452.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_140.reportedUserId > 0)
         {
            this.var_1008.load(_loc4_,this.var_140.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_140.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_140.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_62 != null && this.var_62.issueManager != null && this.var_140 != null)
         {
            this.var_62.issueManager.removeHandler(this.var_140.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.closeBundle(this.var_140.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.closeBundle(this.var_140.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.closeBundle(this.var_140.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function method_4(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.releaseBundle(this.var_140.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_140.getHighestPriorityIssue().issueId;
         this.var_62.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_62,WindowTracker.const_1120,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_140.getHighestPriorityIssue();
            this.var_452 = new UserInfoCtrl(this._window,this.var_62,_loc3_.message);
