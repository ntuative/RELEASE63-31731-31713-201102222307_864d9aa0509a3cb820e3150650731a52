package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1188:IDropMenuWindow;
      ...
      private var var_1470:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_32.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_338));
         Logger.log("BEGINNING TO SHOW: " + this.var_338);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_338);
         if(param1.flatId != this.var_338)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_338);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1188 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1188);
         this.var_1188.procedure = this.onSelectTemplate;
         this.var_982 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1469 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1470 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_32,WindowTracker.const_625,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_982.isSelected);
         this.var_32.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1647,_loc2_,this.var_515.text,"",""));
         if(this.var_1469.isSelected || this.var_1470.isSelected || this.var_982.isSelected)
         {
            this.var_32.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1469.isSelected,this.var_1470.isSelected,this.var_982.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1433);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1440);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_32.initMsg.roomMessageTemplates[this.var_1188.selection];
         if(_loc3_ != null)
         {
            this.var_627 = false;
