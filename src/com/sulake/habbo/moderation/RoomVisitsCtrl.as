package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_824:Array = [];
      
      private static var var_1534:int = 200;
      ...
      {
         this.var_668 = IWindowContainer(this.var_32.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_824.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_668.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_824.length < var_1534)
         {
            ...
            param1.width = this.var_668.width;
            param1.height = this.var_668.height;
            var_824.push(param1);
         }
         else
         {
