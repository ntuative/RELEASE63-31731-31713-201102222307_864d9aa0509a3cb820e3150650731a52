package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1106:String = "issue_bundle_open";
      
      public static const const_856:String = "issue_bundle_my";
      
      public static const const_990:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_551 = new IssueBrowser(this,this.var_62.windowManager,this.var_62.assets);
         this.var_1031 = [];
         this.var_1030 = [];
         this.var_830 = new Map();
         this.var_2101 = parseInt(this.var_62.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1546 = new Timer(const_1542,0);
         this.var_1546.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1546.start();
      }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1030 = this.var_1030.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_551 == null || !this.var_551.isOpen())
         {
            this.var_62.soundManager.playSound(HabboSoundTypesEnum.const_1155);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_829.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_829.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1366)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_98)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_829.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            this.var_829.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_166)
         {
            ...
            _loc9_ = this.var_1030.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2101);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_830.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_830.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_829.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_98.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_830.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_830.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_830.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
