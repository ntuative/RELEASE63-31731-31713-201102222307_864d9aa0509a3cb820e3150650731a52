package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1713:int = 1000;
      ...
      private var var_1712:IMessageComposer;
      ...
      {
         this.var_727 = IWindowContainer(this.var_32.getXmlWindow("chatlog_roomheader"));
         this.var_726 = IWindowContainer(this.var_32.getXmlWindow("chatlog_chatline"));
         this.var_457 = new Timer(1000,1);
         ...
         this.var_32.connection.send(this.var_1712);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_726.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_898.length < var_1713)
         {
            ...
            param1.width = this.var_726.width;
            param1.height = this.var_726.height;
            var_898.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1714[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1357.getValue(param2.chatterName))
            {
               this.var_1357.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1357.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1359)
         {
