package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_916:int = 60;
      
      private static const const_918:int = 3600;
      
      private static const const_917:int = 86400;
      
      private static const const_915:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         if(param1 < 2 * const_918)
         {
            return Math.round(param1 / const_916) + " mins ago";
         }
         if(param1 < 2 * const_917)
         {
            return Math.round(param1 / const_918) + " hours ago";
         }
         if(param1 < 2 * const_915)
         {
            return Math.round(param1 / const_917) + " days ago";
         }
         return Math.round(param1 / const_915) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1081.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_32.getXmlWindow("user_info"));
            this.var_1081.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_32,WindowTracker.const_1065,this._data.userId),this._callerFrame,this.var_1080,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new RoomVisitsCtrl(this.var_32,this._data.userId),this._callerFrame,this.var_1080,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new SendMsgsCtrl(this.var_32,this._data.userId,this._data.userName,this.var_1437),this._callerFrame,this.var_1080,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ModActionCtrl(this.var_32,this._data.userId,this._data.userName,this.var_1437),this._callerFrame,this.var_1080,false,true);
      }
