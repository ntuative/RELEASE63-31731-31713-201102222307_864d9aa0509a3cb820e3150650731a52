package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_717:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2186 = param2.pickerUserId;
         this.var_2326 = param2.pickerUserName;
         this.var_1323 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1111 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1112;
         }
         if(this.var_717 == null || param1.timeStamp < this.var_717.timeStamp)
         {
            this.var_717 = param1;
         }
         if(this.var_716 == null || param1.priority > this.var_716.timeStamp)
         {
            this.var_716 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_716;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_717;
         if(_loc2_ == null)
         {
