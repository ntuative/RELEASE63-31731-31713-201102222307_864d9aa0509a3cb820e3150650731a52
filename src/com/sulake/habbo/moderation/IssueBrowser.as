package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1992:String = "my_issues";
      
      private const const_1993:String = "open_issues";
      
      private const const_1991:String = "picked_issues";
      
      private const const_1999:String = "closed_issues";
      ...
      private var var_1908:IIssueBrowserView;
      
      private var var_1910:IIssueBrowserView;
      
      private var var_1909:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_373.view.width = this.var_266.container.width;
         this.var_373.view.height = this.var_266.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1992:
               ...
               {
                  this.var_1908 = new MyIssuesView(this.issueManager,this,this.var_266.container);
               }
               return this.var_1908;
            case this.const_1993:
               if(this.var_1910 == null)
               {
                  this.var_1910 = new OpenIssuesView(this.issueManager,this,this.var_266.container);
               }
               return this.var_1910;
            case this.const_1991:
               if(this.var_1909 == null)
               {
                  this.var_1909 = new PickedIssuesView(this.issueManager,this,this.var_266.container);
               }
