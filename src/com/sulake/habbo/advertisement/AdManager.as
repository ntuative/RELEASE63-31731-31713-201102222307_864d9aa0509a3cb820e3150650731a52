package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1175:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2543 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2542 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2541 = int(this._config.getKey("interstitial.show.time","5000"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1828 > 0 && this.var_1829 >= this.var_1828)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1176;
         if(_loc1_ > this.var_2542)
         {
            ++this.var_1829;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1422 = _loc2_.imageUrl;
         this.var_2544 = _loc2_.clickUrl;
         this.var_1176 = getTimer();
         if(this.var_1422 != "")
         {
            _loc3_ = this.var_1422;
            ...
            {
               this.var_221 = new Timer(this.var_2541,1);
            ...
            this.var_221.start();
            _loc4_ = new URLRequest(this.var_1422);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_423,0,0,param1.bitmapData,this.var_2544));
            this.var_1176 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_548));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1423 = _loc2_.imageUrl;
         this.var_1830 = _loc2_.clickUrl;
         if(this.var_1423 != "" && this.var_1830 != "")
         {
            ...
            _loc4_ = new URLRequest(this.var_1423);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_443,0,0,_loc4_,this.var_1830,this.var_1175,this.var_1177));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1175 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
