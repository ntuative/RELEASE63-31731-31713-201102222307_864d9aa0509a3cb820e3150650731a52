package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         if(this.var_861 >= this.getPageCount())
         {
            this.var_861 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_211.length / const_339);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_861 * const_339;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_861 + 1) * const_339,this.var_211.length);
      }
