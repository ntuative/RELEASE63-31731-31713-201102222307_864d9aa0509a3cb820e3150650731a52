package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      {
         this.var_1872 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1871 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1871.procedure = this.onDismissAllButtonClick;
         this.var_1872.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1046)
         {
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_409 && _loc4_.state != FriendRequest.const_333)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1872,_loc1_);
         this.setEnabled(this.var_1871,_loc1_);
      }
