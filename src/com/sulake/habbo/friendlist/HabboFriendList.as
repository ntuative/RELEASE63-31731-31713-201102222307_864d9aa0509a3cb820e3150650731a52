package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1003:IAvatarRenderManager;
      
      private var var_742:ISessionDataManager;
      
      private var var_2454:FriendListLookAndFeel;
      
      private var var_391:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1763:OpenedToWebPopup;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_600.stop();
            this.var_600.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_600 = null;
         }
         ...
         if(this.var_1003)
         {
            this.var_1003.release(new IIDAvatarRenderManager());
            this.var_1003 = null;
         }
         if(this.var_878)
         {
            this.var_878.release(new IIDHabboNotifications());
            this.var_878 = null;
         }
         if(this.var_182)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1763 = new OpenedToWebPopup(this);
         }
         this.var_1763.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_355.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_182.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_310,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1003.createAvatarImage(param1,AvatarScaleType.const_85,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_167.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_167.getKey(param1,param1,param2);
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1003 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_182 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_878 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_355 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_95.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_1036,this.getText("friendlist.friends")));
         ...
         if(!this.var_600)
         {
            this.var_600 = new Timer(120000);
            this.var_600.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_600.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_182.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_119,HabboToolbarIconEnum.FRIENDLIST));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_355.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_355.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_391.findTab(FriendListTab.const_95).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_355.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_391.findTab(FriendListTab.const_95);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1764.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_391.findTab(FriendListTab.const_95);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_742 || !this.var_355)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_742.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_41))
         {
            _loc2_ = this.var_355.vipLimit;
         }
         else if(this.var_742.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_40))
         {
            _loc2_ = this.var_355.clubLimit;
         }
         if(_loc2_ > this.var_355.limit)
         {
            this.var_355.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_165) as IBitmapWrapperWindow;
