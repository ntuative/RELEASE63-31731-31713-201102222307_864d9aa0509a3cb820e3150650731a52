package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1670:String = "noconvinfo";
      
      private static const const_1669:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1348:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1348 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_919 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_255 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1348.prepare(this.var_919);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1052,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_998,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_655,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_656,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_655,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_656,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1349 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1349.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1688 == -1 ? 0 : int(this.var_16.height - this.var_1688);
         var _loc4_:int = this.var_1689 == -1 ? 0 : int(this.var_16.width - this.var_1689);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1165,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_655,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1052,false);
         ...
         this.var_1688 = this.var_16.height;
         this.var_1689 = this.var_16.width;
