package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2442:PseudoRandom;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_599 = param1;
            this.var_51.initConnection(HabboConnectionType.const_219);
         }
      }
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_599 = this.var_153.getKey("sso.ticket",null);
         this.var_1754 = this.var_153.getKey("flash.client.url","");
         this.var_2443 = this.var_153.getKey("external.variables.txt","");
         if(this.var_216 == null)
         {
            this.var_216 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_51.mode = HabboConnectionType.const_86;
            if(this.var_599)
            {
               this.var_51.initConnection(HabboConnectionType.const_219);
            }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_51.mode = HabboConnectionType.const_1118;
            }
         }
         this.var_51.initConnection(HabboConnectionType.const_219);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_774);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2442 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_51.mode)
         {
            case HabboConnectionType.const_86:
               ...
               this.var_216.loadBannerImage(_loc7_ + "?token=" + this.var_1379,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1118:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1529:
               this.var_917 = this.generateRandomHexString(30);
               this.var_496 = new DiffieHellman(new BigInteger(this.var_153.getKey("connection.development.prime"),16),new BigInteger(this.var_153.getKey("connection.development.generator"),16));
               this.var_496.init(this.var_917);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2442);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1754,this.var_2443));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1679,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_599 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_599);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1380)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_172);
         }
         if(param1.type == Event.CLOSE && !this.var_2444)
         {
