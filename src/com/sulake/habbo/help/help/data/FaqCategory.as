package com.sulake.habbo.help.help.data
{
   ...
   public class FaqCategory
   {
      ...
      public function storeItem(param1:int, param2:String, param3:String = null) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = new FaqItem(param1,param2,this.var_148.length,this);
      ...
      {
         return this.var_148.getValue(param1) != null;
      }
      ...
      {
         return this.var_148.length > 0 || this.hasUpdatedWithinHour();
      }
