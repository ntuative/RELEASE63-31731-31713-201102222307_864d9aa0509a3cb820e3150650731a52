package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201102222302));
         this.var_182 = param5;
         this.var_113 = new Map();
         this.var_113.add(HabboHelpViewEnum.const_1358,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_180,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         ...
         this.var_113.add(HabboHelpViewEnum.const_293,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_270,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_341,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_742,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_232,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_113.add(HabboHelpViewEnum.const_1206,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_113.add(HabboHelpViewEnum.const_1134,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_784,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_512.length == 0 || param1 != this.var_367)
            {
               this.var_512.push(this.var_367);
            }
         }
         this.var_367 = param1;
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_182.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_232:
               this.showUI(HabboHelpViewEnum.const_232);
               break;
            case CallForHelpResultEnum.const_1186:
               this.showUI(HabboHelpViewEnum.const_1134);
               break;
            case CallForHelpResultEnum.const_987:
               this.showUI(HabboHelpViewEnum.const_1206);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_113.getValue(HabboHelpViewEnum.const_180) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_551));
      }
      ...
      {
         return this.var_113.getValue(this.var_367);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2168 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2167;
         this._window.width = _loc1_.width + this.var_2168;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_512.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_367 == HabboHelpViewEnum.const_180)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_367 == HabboHelpViewEnum.const_180 || this.var_512.length == 0)
         {
            return;
         }
         if(this.var_366 == null)
         {
            ...
            this.var_366 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_366.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_366.findChildByName("back_text");
            if(_loc5_ != null)
            {
