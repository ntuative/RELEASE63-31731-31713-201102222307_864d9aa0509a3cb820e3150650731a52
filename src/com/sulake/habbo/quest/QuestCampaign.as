package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_471:Quest;
      
      private var var_285:QuestView;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1301 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_284 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.code + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1301.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1301.findChildByName("currency.amount").caption = "${quest_" + this.var_1579 + ".currency}";
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_471)
         {
            this.var_471.selected = false;
         }
         if(this.var_177)
         {
            this.var_1067.addChild(this.var_177.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1531);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1301.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         for each(_loc4_ in this.var_330)
         {
            ...
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_46 || _loc4_.status == QuestStatusEnum.const_522))
            {
               _loc3_ = _loc4_;
            }
         }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_471 = param1;
         this.var_471.selected = true;
         this.showQuestData(this.var_471);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_285 = new QuestView(this,param1);
         this.var_1067.addChild(this.var_285.view);
         this.var_285.init();
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_687.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         for each(_loc3_ in this.var_687)
         {
            if(_loc3_ == param1)
            {
               _loc2_ = _loc3_;
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_687.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_687.splice(_loc4_,1);
            }
         }
      }
