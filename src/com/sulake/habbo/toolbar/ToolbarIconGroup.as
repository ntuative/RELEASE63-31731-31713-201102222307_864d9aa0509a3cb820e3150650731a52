package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_562:ToolbarBarMenuAnimator;
      ...
      {
         return this.var_1453.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2678.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_774.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1454.length)
         {
            _loc2_ = this.var_774.indexOf(this.var_1454[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_311[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1011 + _loc3_);
                  _loc3_ += this.var_1452;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_311[this.var_774.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,this._windowManager,this._assetLibrary,param1,this._events,this.var_562);
