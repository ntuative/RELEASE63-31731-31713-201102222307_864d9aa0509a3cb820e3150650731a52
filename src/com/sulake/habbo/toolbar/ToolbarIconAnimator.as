package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1281 = param1.loop;
         if(param1.background != null)
         {
            this.var_844 = this.getBitmapDataFromAsset(param1.background,param2);
         }
      ...
      {
         if(this.var_1281 == true || this.var_845 == 0)
         {
      ...
      {
         return this.var_1281 == false && this.var_845 == 1 && this.var_1529 != this._state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_844.width),Math.max(param2.height,this.var_844.height));
            _loc3_.copyPixels(this.var_844,this.var_844.rect,new Point(0,0));
