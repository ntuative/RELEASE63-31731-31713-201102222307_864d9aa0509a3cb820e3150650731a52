package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1292:Number = 25;
      
      private static const const_1349:Number = 90;
      
      private static const const_932:int = 50;
      ...
      private var var_1356:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_590 = new Object();
         this.var_589 = new Array();
         this.var_591 = new Array();
         super();
         this._windowManager = param1;
         this.var_1356 = param2;
         this.var_725 = new Timer(const_1292);
         this.var_725.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      {
         return param1.x + param1.width < const_932 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_932 || param1.desktop.height - param1.y < const_1293;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1356.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = this.var_1356.getIconLoc(param1.iconId);
      ...
      {
         return this.var_589[this.var_591.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_591[this.var_589.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_591.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_591.splice(_loc3_,1);
            this.var_589.splice(_loc3_,1);
         }
         this.var_589.push(param1.name);
         this.var_591.push(param2);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_590[_loc3_] == null)
            {
               this.var_590[_loc3_] = new Array();
            }
            if(this.var_590[_loc3_].indexOf(param1) < 0)
            {
               this.var_590[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < this.var_589.length)
         {
            ...
            {
               _loc3_ = this.var_591[_loc2_];
               if(this.var_590[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_590[_loc3_].length)
                  {
                     this.repositionWindow(this.var_590[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
