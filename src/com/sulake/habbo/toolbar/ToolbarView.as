package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1637:Number = 15;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         this.var_213 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_60,HabboWindowStyle.const_1049,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1102 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1102)
         {
         ...
         this.var_1101 = _loc6_.toolbar.@margin_top;
         this.var_1325 = _loc6_.toolbar.@margin_bottom;
         this.var_1637 = _loc6_.toolbar.@min_group_margin;
         this.var_1638 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_283 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_242,param1,param2,this._window,this.var_283);
         this.createGroupsFromXmlList(_loc8_,this.var_575,param1,param2,this.var_213,this.var_283);
         this.alignWindows();
      }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_213 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_213.x = this.var_146 + this.var_1638;
               this.var_213.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_213.x = 0;
               this.var_213.y = this.var_146 + this.var_1638;
         ...
         _loc4_ -= this.var_1325;
         _loc4_ -= this.var_1101;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1101;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_242.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1637,(this._window.height - _loc5_ * _loc8_ - this.var_1101 - this.var_1325) / (this.var_242.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1637,(this._window.width - _loc5_ * _loc8_ - this.var_1101 - this.var_1325) / (this.var_242.length - 1)));
               }
            }
         }
         _loc2_ = 0;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1102 && this.var_1324)
         {
