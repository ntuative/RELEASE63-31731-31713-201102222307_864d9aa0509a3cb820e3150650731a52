   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(var_65,FigureData.const_227,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_65,FigureData.const_191,_windowManager,_assetLibrary);
         ...
         if(var_65 && var_138 == "")
         {
            var_65.switchCategory(FigureData.const_191);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_jacket":
                  ...
                  break;
               case "tab_shirt":
                  this.switchCategory(FigureData.const_191);
                  break;
