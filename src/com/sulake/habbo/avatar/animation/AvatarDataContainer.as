package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_1923 = new ColorTransform(this.var_1664,this.var_1663,this.var_1662,this._alphaMultiplier);
         this.var_1190 = this.generatePaletteMapForGrayscale(this.var_2586,this.var_2587);
      }
