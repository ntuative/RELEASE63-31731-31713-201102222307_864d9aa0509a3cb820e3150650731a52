package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1319:String = "Default";
      
      private static const const_1318:int = 2;
      
      private static const const_1317:String = AvatarSetType.const_34;
      ...
      protected var var_270:IActiveActionData;
      ...
      protected var var_254:AvatarImageCache;
      
      protected var var_540:AvatarFigureContainer;
      ...
      private var var_2474:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_540 = param3;
         this.var_254 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1317,const_1318);
         this.var_315 = new Array();
         this.var_962 = new ActiveActionData(AvatarAction.const_398);
         this.var_962.definition = this._structure.getActionDefinition(const_1319);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_540,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1767;
         if(param2 < AvatarDirectionAngle.const_973)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_251.length == 1 && this.var_88 == this.var_1984)
         {
            return this.var_88 + this.var_502 + this.var_604 % 4;
         }
      ...
      {
         if(param3 != this.var_2473 || param2 != this.var_2474 || param1 != this.var_2472)
         {
            this.var_2473 = param3;
            this.var_2474 = param2;
            this.var_2472 = param1;
            this.var_1768 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_270.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1234 || this.var_44 == null || (this.var_44.width != _loc5_.width || this.var_44.height != _loc5_.height))
         {
            if(this.var_44 != null && !this.var_1234)
            {
               this.var_44.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_270.definition.geometryType,this.var_88);
         this.var_44.lock();
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_270.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_270.definition.geometryType,this.var_88);
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_315.push(new ActiveActionData(param1,param2,this.var_604));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_270 = this.var_962;
         this.var_270.definition = this.var_962.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_502 = "";
         this.var_251 = this._structure.sortActions(this.var_315);
         if(this.var_251 == null)
         {
            this.var_698 = new Array(0,0,0);
            if(this.var_1386 != "")
            {
               _loc1_ = true;
               this.var_1386 = "";
         ...
         {
            this.var_698 = this._structure.getCanvasOffsets(this.var_251,this._scale,this.var_88);
            ...
            if(this.var_1386 != this.var_502)
            {
               _loc1_ = true;
               this.var_1386 = this.var_502;
            }
         }
         this.var_1388 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_251)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_320 || _loc1_.actionType == AvatarAction.const_239 || _loc1_.actionType == AvatarAction.const_387)
               {
                  this.var_961 = true;
               }
            }
