package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_254:AvatarImageCache;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_540 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_540.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1430 = this.var_1208;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_49)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1430);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_270.definition.geometryType);
         if(this.var_44 == null || _loc4_ != null && (this.var_44.width != _loc4_.width || this.var_44.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_270.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_540,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1430 < 3;
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_540,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_85)
               {
                  _loc17_ = 6;
      ...
      private function sortActions() : void
      {
         ...
         this.var_1431 = this._structure.sortActions(this.var_315);
         ...
         {
            this.var_698 = this._structure.getCanvasOffsets(this.var_1431,this._scale,this.var_88);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1431)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_387)
               {
                  this.var_961 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_239)
               {
                  this.var_961 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_320)
               {
                  this.var_961 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1208 = _loc4_.id;
                     this.var_1594 = _loc4_.breed;
                     break;
                  }
               }
            }
