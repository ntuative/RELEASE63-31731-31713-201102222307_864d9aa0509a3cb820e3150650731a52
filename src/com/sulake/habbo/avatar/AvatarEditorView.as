package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1479:IWindowContainer;
      ...
      private var var_489:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1114 = [];
         this.var_1270 = [AvatarEditorFigureCategory.const_769,AvatarEditorFigureCategory.const_49,AvatarEditorFigureCategory.const_242,AvatarEditorFigureCategory.const_785,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_100];
         super();
         ...
         if(var_1479 == null)
         {
            ...
            var_1479 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_409 = new Timer(1000);
         this.var_409.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1270;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1270);
         }
         if(param1.length != this.var_1114.length)
         {
            return false;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2329 = this.canChangeOutfit();
            this.var_409.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_489 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_489.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_489.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1114.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_489.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_489.numSelectables)
               {
                  this.var_489.getSelectableAt(_loc6_).x = this.var_489.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1270;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_40) && (this.var_1673 == AvatarEditorSideCategory.const_100 || this.var_2328))
         {
      ...
      {
         if(this.var_1673 == AvatarEditorSideCategory.const_100)
         {
            this.var_2328 = false;
            this.setSideContent(AvatarEditorSideCategory.const_858);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_858:
               break;
            case AvatarEditorSideCategory.const_472:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_472);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_367 = param1;
         this.var_489.setSelected(this.var_489.getSelectableByName(param1));
