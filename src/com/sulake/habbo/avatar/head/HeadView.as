   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(var_65,FigureData.const_182,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_65,FigureData.const_222,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_65,FigureData.const_266,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_65,FigureData.const_228,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_65,FigureData.const_236,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_65 && var_138 == "")
         {
            var_65.switchCategory(FigureData.const_182);
         }
      }
