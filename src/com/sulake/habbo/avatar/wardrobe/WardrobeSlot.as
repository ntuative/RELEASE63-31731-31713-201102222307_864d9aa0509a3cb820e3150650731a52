package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_540 && this.var_1247)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_85,this.var_811,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_34,parseInt(FigureData.const_820));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_540 = this._controller.figureData.getFigureString();
               this.var_811 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1494,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_540)
               {
                  this._controller.loadAvatarInEditor(this.var_540,this.var_811,this._controller.clubMemberLevel);
               }
         }
      }
