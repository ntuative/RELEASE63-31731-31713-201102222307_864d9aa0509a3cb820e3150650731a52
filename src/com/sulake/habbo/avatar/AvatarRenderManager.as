package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1948:String = "hd-99999-99999";
      ...
      private var var_278:PetDataManager;
      
      private var var_673:PaletteManager;
      ...
      private var var_1549:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_609 = RenderMode.const_1372;
         ...
         this.var_99.add(AvatarType.const_114,_loc4_);
         ...
         this.var_99.add(AvatarType.const_68,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_278 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_673 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_278.populateFigureData(_loc5_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_278.init();
         this.var_673.init();
         _loc2_ = this.var_99.getValue(AvatarType.const_114) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_99.getValue(AvatarType.const_68) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_99.getValue(AvatarType.const_114) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_167.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_209 == null)
               {
                  ...
                  _loc6_ = this.var_167.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_167.getKey("flash.dynamic.avatar.download.url","");
      ...
      private function checkIfReady() : void
      {
         if(!this.var_922)
         {
            if(this.var_2109 && this.var_2108 && this.var_2110)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_99.getValue(AvatarType.const_114) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1549)
         {
            this.var_1549 = new AvatarFigureContainer(this.const_1948);
         }
         this.var_209.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1549,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc3_ in this.var_277.getKeys())
         {
            _loc4_ = this.var_277.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_278.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1565)
         {
            _loc6_ = !this.var_278.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_278.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_99.getValue(AvatarType.const_68) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_277.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_278.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_99.getValue(AvatarType.const_68);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_277.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_277.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_99.getValue(AvatarType.const_114) as AvatarStructure;
      ...
      {
         return this.var_278 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_68:
               _loc3_ = this.var_99.getValue(AvatarType.const_68) as AvatarStructure;
               break;
            default:
