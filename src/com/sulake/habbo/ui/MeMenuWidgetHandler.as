   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_724,this.onAvatarEffectsChanged);
            ...
            {
               this.var_182.events.removeEventListener(HabboToolbarEvent.const_65,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_497,this.onHelpTutorialEvent);
         ...
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_724,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_804,this.onHabboClubSubscriptionChanged);
         }
         this.var_182 = this._container.toolbar;
         if(this.var_182 != null)
         {
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_497,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            {
               _loc1_ = this.var_1818;
            }
         }
         if(this.var_182 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1003,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_182.events.dispatchEvent(_loc5_);
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_852);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_854);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_874);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_388);
         _loc1_.push(RoomWidgetStopEffectMessage.const_667);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1626);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1082);
         _loc1_.push(RoomWidgetToolbarMessage.const_618);
         _loc1_.push(RoomWidgetToolbarMessage.const_750);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_382);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1548);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1006);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_612);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_764);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_677);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1439);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_866);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_806);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_811);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_764:
            ...
            case RoomWidgetWaveMessage.const_798:
               ...
               break;
            case RoomWidgetDanceMessage.const_852:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_854:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_388:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1011)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_874:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1024:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1158:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1533:
            ...
            case RoomWidgetSetToolbarIconMessage.const_1201:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1558:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.widgetType);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_1082:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_612:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_618:
               ...
               if(this.var_182)
               {
                  this.var_182.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
            ...
            case RoomWidgetToolbarMessage.const_750:
               ...
               {
                  this.var_182.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_474,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_382:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_677:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_866:
            ...
            case RoomWidgetStoreSettingsMessage.const_806:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_404,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_811:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
            ...
            case RoomWidgetClothingChangeMessage.const_395:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_737));
               break;
            default:
