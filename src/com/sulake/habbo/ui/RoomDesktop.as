package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1014:IRoomWidgetFactory = null;
      
      private var var_405:ISessionDataManager = null;
      
      private var var_15:IRoomSessionManager = null;
      
      private var var_450:IAvatarRenderManager = null;
      ...
      private var var_1167:IHabboHelp = null;
      ...
      private var var_187:DesktopLayoutManager;
      ...
      private var var_2034:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         this.var_187 = new DesktopLayoutManager();
      }
      ...
      {
         this.var_182 = param1;
         this.var_182.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         this.var_182.events.addEventListener(HabboToolbarEvent.const_38,this.onHabboToolbarEvent);
      }
      
      public function set layout(param1:XML) : void
      {
         this.var_187.setLayout(param1,this._windowManager);
         if(this.var_182 != null)
         {
            this.var_187.toolbarSize = this.var_182.size;
            this.var_187.toolbarOrientation = this.var_182.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_182 && this.var_182.events)
         {
            this.var_182.events.removeEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
            this.var_182.events.removeEventListener(HabboToolbarEvent.const_38,this.onHabboToolbarEvent);
         }
         this.var_182 = null;
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_29 != null)
         {
            this.var_658 = this._roomEngine.loadRoomResources(this.var_29.roomResources);
         ...
         if(this.var_301 != null && this.var_29.state == RoomSessionEvent.const_221)
         {
            this.var_1506 = !this.var_301.showInterstitial();
         }
      ...
      private function onRoomContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         var _loc2_:int = this.var_658.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1014.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_187.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = this.var_660.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_660.add(_loc9_,_loc6_);
                  }
                  else
                  {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = this.var_659.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_659.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc3_);
               }
            }
         ...
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,this.var_187.roomViewRect);
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_712:
               ...
               if(this.var_947 != null && _loc3_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER)
               {
               ...
               break;
            case RoomEngineObjectEvent.const_318:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_433:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_129,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_644:
               if(!this.var_29.isRoomController && !this.var_405.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_136:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1040,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc21_:* = null;
         var _loc2_:Rectangle = this.var_187.roomViewRect;
         var _loc3_:int = _loc2_.width;
         var _loc4_:int = _loc2_.height;
         var _loc5_:int = 0;
         if(this.var_274.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_763);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_832);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_884);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_728);
         ...
         this.var_187.addRoomView(_loc9_);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2034);
      ...
      {
         var _loc3_:IWindowContainer = this.var_187.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function getRoomViewRect() : Rectangle
      {
         ...
         return this.var_187.roomViewRect;
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            this._roomEngine.handleRoomCanvasMouseEvent(this.var_274[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this._roomEngine.modifyRoomCanvas(this.var_29.roomId,this.var_29.roomCategory,this.var_274[0],_loc2_.width,_loc2_.height);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.var_187.toolbarOrientation = param1.orientation;
         }
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1504) / 1000);
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(this.var_29 != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  {
                     _loc3_.iconState = "2";
                     this.var_182.events.dispatchEvent(_loc3_);
                  }
                  else
                  {
                     _loc3_.iconState = "0";
      ...
      {
         if(this.var_15 != null && this.var_29 != null && this.var_1506 && this.var_1505)
         {
            this.var_15.startSession(this.var_29);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_539:
               ...
               this.var_204 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_357,WindowStyle.const_813,WindowParam.const_97) as IToolTipWindow;
               this.var_204.setParamFlag(WindowParam.const_30,false);
