package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_796,RoomWidgetViralFurniMessage.const_646,RoomWidgetViralFurniMessage.const_158];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_796:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_458);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_646:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendViralFurniFoundMessage();
               }
               break;
            case RoomWidgetViralFurniMessage.const_158:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_450,RoomSessionViralFurniStatusEvent.const_461];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_450:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_848);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_461:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
