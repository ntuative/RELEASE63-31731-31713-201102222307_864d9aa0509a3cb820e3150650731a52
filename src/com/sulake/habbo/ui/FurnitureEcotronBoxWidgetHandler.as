package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_730,RoomWidgetEcotronBoxOpenMessage.const_859,RoomWidgetEcotronBoxOpenedMessage.const_1556];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_730:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_859:
