package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_835);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_651);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_710);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_835:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_651:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_710:
