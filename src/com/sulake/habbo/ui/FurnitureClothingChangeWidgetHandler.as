package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1326:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      
      private static const const_1327:String = "hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68";
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         var _loc2_:RoomWidgetClothingChangeUpdateEvent = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_403);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_799,RoomWidgetClothingChangeMessage.const_395,RoomWidgetAvatarEditorMessage.const_382];
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetClothingChangeMessage.const_395:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     this.var_348 = _loc7_.objectId;
                     _loc9_ = "null";
                     _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1045);
                     if(_loc10_ == null)
                     {
                        _loc10_ = const_1326;
                     }
                     ...
                     {
                        _loc9_ = "null";
                        _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1031);
                        if(_loc10_ == null)
                        {
                           _loc10_ = const_1327;
                        }
                     }
                     if(this._container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_242,AvatarEditorFigureCategory.const_785],true))
                     {
                        _loc11_ = 0;
            ...
            case RoomWidgetAvatarEditorMessage.const_382:
               _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_403);
               this._container.events.dispatchEvent(_loc5_);
         }
         return null;
      }
      ...
      public function saveFigure(param1:String, param2:String) : void
      {
         ...
         this._container.roomSession.sendUpdateClothingChangeFurniture(this.var_348,param2,param1);
