package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_561.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_561.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_871);
         ...
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_663);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1645);
         _loc1_.push(RoomWidgetPetCommandMessage.const_532);
         _loc1_.push(RoomWidgetPetCommandMessage.const_883);
         _loc1_.push(RoomWidgetUserActionMessage.const_456);
         _loc1_.push(RoomWidgetUserActionMessage.const_360);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_831);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_360 || param1.type == RoomWidgetUserActionMessage.const_456 || param1.type == RoomWidgetUserActionMessage.const_469)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_754:
               ...
               break;
            case RoomWidgetUserActionMessage.const_456:
               this._container.sessionDataManager.givePetRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_691:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1198,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_726:
               ...
               break;
            case RoomWidgetUserActionMessage.const_871:
            ...
            case RoomWidgetUserActionMessage.const_360:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_663:
            ...
            case RoomWidgetUserActionMessage.const_744:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_883:
            ...
            case RoomWidgetPetCommandMessage.const_532:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_831:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1114);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1096);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_183)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_195)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_886)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_509);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_109)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_151)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc31_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_773);
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_977;
                  }
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1051;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1629);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_561.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_561.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_773);
