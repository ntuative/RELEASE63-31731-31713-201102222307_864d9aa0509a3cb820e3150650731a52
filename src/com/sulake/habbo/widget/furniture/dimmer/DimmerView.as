package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_60,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1289,const_1288,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1417 = _loc2_.light;
         if(this.var_426 != null)
         {
            this.var_426.setValue(this.var_1417);
         }
         this.var_491 = this.colors.indexOf(_loc2_.color);
         if(this.var_619 != null)
         {
            this.var_619.setSelectedColorIndex(this.var_491);
         }
