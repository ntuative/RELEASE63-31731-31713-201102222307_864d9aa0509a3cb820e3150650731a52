package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1562) as IWindowContainer;
            ...
            _loc3_.width = this.var_559.width;
            _loc3_.height = this.var_559.height;
            this.var_467.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_559.width,this.var_559.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_559,this.var_559.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1048.width,this.var_1048.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_849.width,this.var_849.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_849,this.var_849.rect,new Point(0,0),null,null,true);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_1562 = XML(_loc2_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_frame"));
         this.var_559 = BitmapData(_loc3_.content);
         ...
         this.var_849 = BitmapData(_loc3_.content);
      }
