package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1701:int = 4;
      ...
      private const const_1985:int = 3;
      
      private const const_1984:int = 4;
      
      private const const_1979:int = 5;
      
      private const const_1700:String = "deco_img";
      
      private const const_1699:String = "dialog_bg";
      
      private const const_1986:String = "%campaign%_dialog_bg.png";
      
      private const const_330:String = "%campaign%_gift_package.png";
      
      private const const_1981:String = "%campaign%_gift_content.png";
      
      private const const_1982:String = "%campaign%_friend_gift_package.png";
      ...
      override public function dispose() : void
      {
         ...
         this.hideInterface();
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1445.length)
         {
            _loc2_ = this.var_1445.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_153 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_458,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_848,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_458,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_458:
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_756:
               ...
               this._shareId = null;
               this.var_1447 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_848:
               _loc2_ = this.const_1703;
               this.var_348 = param1.objectId;
         ...
         if(!this._window)
         {
            switch(this.var_1446)
            {
               ...
               case this.const_1703:
                  if(this.var_378 == this.const_1987)
                  {
                  ...
                  else if(this.var_378 == this.const_1983)
                  {
                  ...
                  else if(this.var_378 == this.const_1980)
                  {
                  ...
                  else if(this.var_378 == this.const_1984)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_178,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_378 == this.const_1979)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_1986.replace("%campaign%",this.var_178);
            this.setDecoImage(_loc5_,this.const_1699);
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_646);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_158);
            _loc2_.objectId = this.var_348;
            messageListener.processWidgetMessage(_loc2_);
         }
         this.hideInterface();
         if(this._inventory)
         {
            if(this.var_1447 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1447 == 1 ? "null" : InventoryCategory.const_133);
            }
         }
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1445.push(new ImageDownloader(this,_assets,this.var_178,this._imageUrlPath,param1,param2));
            return;
         }
