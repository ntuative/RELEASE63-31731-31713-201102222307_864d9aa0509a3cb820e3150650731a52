package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_364,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_364,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomWidgetPetPackageUpdateEvent.const_432:
               ...
               break;
            case RoomWidgetPetPackageUpdateEvent.const_364:
               if(event.objectId != this.var_348)
               {
                  return;
               }
               this.var_582 = event.image;
      ...
      private function showInterface() : void
      {
         ...
         this._window.x = const_1289;
         this._window.y = const_1288;
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1110 || this.var_348 == -1)
         {
            return;
         }
         ...
         {
            this.var_1110 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_772,this.var_348,name);
