package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1262:int = 11;
      
      private static const const_593:int = 18;
      
      private static const const_914:int = 16;
      
      private static const const_1263:int = 20;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_2153 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_331 = new Timer(1000,1);
         this.var_331.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_392 = new Timer(10000,1);
         this.var_392.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_331.reset();
            this.var_331.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_331 = null;
         }
         if(this.var_392 != null)
         {
            this.var_392.reset();
            this.var_392.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_392 = null;
         }
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_593 + const_914;
         _loc1_.x = const_593;
         _loc1_.y = const_1262;
      }
      ...
      {
         this.var_296 = param1 - (const_593 + const_914);
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1263);
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_473.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_473 = _loc2_.text;
            if(!this.var_563)
            {
               this.var_563 = true;
               this.var_331.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_563);
