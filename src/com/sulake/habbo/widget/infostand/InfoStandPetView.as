package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1954:int = 152;
      
      private const const_1960:int = 16;
      
      private const const_1253:int = 4;
      
      private const const_1949:uint = 14342874;
      
      private const const_1951:uint = 3815994;
      
      private const const_1953:uint = 2085362;
      
      private const const_1956:uint = 39616;
      
      private const const_1959:uint = 10513106;
      
      private const const_1958:uint = 8734654;
      
      private const const_1950:uint = 9094430;
      
      private const const_1961:uint = 6200576;
      
      private const const_1955:String = "happiness";
      
      private const const_1957:String = "experience";
      
      private const const_1952:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_193 == null || this.var_66 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_193.width,this.var_66.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_193.width < this.var_66.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1955,param1.nutrition,param1.nutritionMax,this.const_1956,this.const_1953);
         this.updateStateElement(this.const_1957,param1.experience,param1.experienceMax,this.const_1958,this.const_1959);
         this.updateStateElement(this.const_1952,param1.energy,param1.energyMax,this.const_1961,this.const_1950);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_1954,this.const_1960,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_1949);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_1951);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1253,_loc7_.width - 2,_loc7_.height - 2 - this.const_1253);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1253);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_477) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_192 && this.var_192.getPetId() == this.var_477)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1516,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_428,this._widget.petData.ownerId);
