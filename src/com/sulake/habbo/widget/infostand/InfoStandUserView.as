package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_625:IWindow;
      
      private var var_193:IBorderWindow;
      
      private var var_1196:TagListRenderer;
      
      private var var_130:IBorderWindow;
      
      private var var_2603:int;
      
      private const const_956:int = 5;
      
      private const const_1694:int = 39;
      
      private const const_1696:int = 7829367;
      
      private const const_1695:int = 16777215;
      
      private const const_1978:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1196 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_956;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_956;
         if(param2)
         {
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1196.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_977:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1051:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2603 > this.const_1978 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2603 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1696;
            if(_loc3_.length >= this.const_1694)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1694 - 1);
            }
         }
      }
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            if(param2.name == "button.give")
            {
               ...
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_625);
               }
               if(_loc3_ <= -1)
               {
                  return;
