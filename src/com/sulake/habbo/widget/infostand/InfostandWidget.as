package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1675:String = "infostand_furni_view";
      
      private const const_1676:String = "infostand_pet_view";
      
      private const const_1678:String = "infostand_bot_view";
      
      private var var_1137:InfoStandFurniView;
      
      private var var_123:InfoStandUserView;
      
      private var var_350:InfoStandPetView;
      
      private var var_415:InfoStandBotView;
      
      private var var_2425:Array;
      
      private var var_1371:InfostandUserData;
      
      private var var_494:InfostandFurniData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1137 = new InfoStandFurniView(this,this.const_1675,this._catalog);
         this.var_123 = new InfoStandUserView(this,this.const_1677);
         this.var_350 = new InfoStandPetView(this,this.const_1676,this._catalog);
         this.var_415 = new InfoStandBotView(this,this.const_1678);
         this.var_1371 = new InfostandUserData();
         this.var_494 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_149 = new Timer(this.const_1974);
         this.var_149.addEventListener(TimerEvent.TIMER,this.onUpdateTimer);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_129,this.onClose);
         ...
         param1.addEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_736,this.onUserGivableBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_822,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_129,this.onClose);
         ...
         param1.removeEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_736,this.onUserGivableBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_822,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_360,this.var_350.getCurrentPetId()));
      }
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_350.update(this.petData);
      ...
      {
         this.var_350.updateEnabledTrainingCommands(param1.id,new CommandConfiguration(param1.allCommands,param1.enabledCommands));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_123.setTags(param1.tags,this.var_2425);
         }
      }
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_147:
               _loc2_ = param1.id == this.var_494.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_160:
               if(this.var_123 != null && this.var_123.window != null && this.var_123.window.visible)
               {
                  _loc2_ = param1.id == this.var_1371.userRoomId;
                  break;
               }
               if(this.var_350 != null && this.var_350.window != null && this.var_350.window.visible)
               {
