package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_950 != null)
         {
            if(this.var_175.isActive)
            {
               ...
               this.var_950.width = _loc2_ * this.var_296;
            }
            else
            {
               this.var_950.width = 0;
               this.var_199.stop();
            }
            this.setTimeLeft();
         }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_949.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_949.text;
            if(this.var_175.isActive)
            {
               _loc2_ = this.var_175.secondsLeft;
               ...
               this.var_949.text = _loc1_;
            }
            else
            {
               this.var_949.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_949 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_950 = this._window.findChildByName("loader_bar");
         if(this.var_950 != null)
         {
            this.var_296 = this.var_950.width;
            this.var_199.start();
            this.onUpdate();
         }
